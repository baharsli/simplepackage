...
class _XoState extends State<Xo> {
  ...
  String lastImagePath = 'assets/xo-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Be the first to align three of your symbols (X or O) in a row, column, or diagonal to win.",
      "image": "assets/Groupxo.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Groupcolorxo.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          ". One player uses black as 'X' and the other uses white as 'O'.\n\n. The game begins with an empty board, and players take turns placing their pieces on the board strategically.",
      "image": "assets/Gamesetupxo.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          ". Players decide who will use X and who will use O.\n. The player assigned 'X' always starts first. Players take turns placing their symbol (X or O) in any empty space on the grid.\n. The goal is to align three symbols in a straight line horizontally, vertically, or diagonally while preventing the opponent from doing the same.",
      "image": "assets/Gameplayxo.svg"
    },
    {
      "title": "Winning Conditions",
      "icon": "assets/winning.svg",
      "description":
          "A player wins by aligning three of their symbols in:\n. A horizontal row of three same pieces.\n. A vertical row of three same pieces.\n. A diagonal row of three same pieces.\nIf all spaces on the grid are filled and no player has aligned three symbols, the game is a draw."
    },
  ];
