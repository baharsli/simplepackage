...
class _RotaState extends State<Rota> {
  ...
  final List<String> _imagePaths = [
    'assets/Rota-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Rota-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Rota is an ancient Roman strategy game similar to tic-tac-toe but with more strategic depth. Players aim to form a straight line of three pieces on a circular board.",
    ...
    },
    {
      ...
      "image": "assets/rotasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players decide who starts, either randomly or by agreement.\nPlayers take turns placing one piece at a time on any empty space (outer or central) until all 6 pieces are placed.\nMovement Phase:\n. Once all pieces are placed, players take turns moving one of their pieces to an adjacent empty space.\n. Movement is allowed along the lines connecting spaces, either to the center or between outer spaces.",
      "image": "assets/Rota1.svg",
      "extraImages": [
        {
          "image": "assets/Rota2.svg",
          "description":
              "A player wins by aligning all 3 of their pieces in a straight line (horizontal, vertical, or diagonal)."
        },
      ]
    },
    {
