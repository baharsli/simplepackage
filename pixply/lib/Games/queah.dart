...
class Queah extends StatefulWidget {
  ...
  _QueahState createState() => _QueahState();
}
...
class _QueahState extends State<Queah> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Queah-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Queah-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Queah is a game originating from Liberia, played on a square grid. The goal is to capture all of the opponent’s pieces.",
    ...
    },
    {
      ...
      "description":
          "Each player places four pieces on their side of the board, occupying the nearest four squares. The remaining six pieces are kept in reserve.",
      "image": "assets/Queahsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The player who places the last piece during the setup typically goes first.\nMovement:\n. Players alternate turns, moving one piece per turn.\n. Pieces move one step to an adjacent vacant cell along the grid lines. Movement is orthogonal, meaning along the lines connecting the cells, not diagonally.",
      "image": "assets/Queah1.svg",
      "extraImages": [
        {
          "image": "assets/Queah2.svg",
          "description":
              "Capturing:\n. A piece captures an opponent’s piece by leaping over it to a vacant cell directly beyond, similar to draughts. Only one piece can be captured per turn; multiple captures are not allowed.\n. Captured pieces are removed from the board. If a player has reserve pieces, they must place one onto any vacant cell on the board at the beginning of their next turn to maintain four pieces on the board. Once all reserve pieces are used, the player continues with fewer pieces."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by capturing all the opponent’s pieces or blocking them so they have no legal moves remaining."
    },
  ];
