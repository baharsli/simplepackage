...
class AduHuli extends StatefulWidget {
  ...
  _AduHuliState createState() => _AduHuliState();
}
...
class _AduHuliState extends State<AduHuli> {
  ...
  final List<String> _imagePaths = [
    'assets/Adu huli-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Adu huli-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Three tigers try to hunt 15 goats, while the goats work together to trap the tigers.",
      "image": "assets/Groupbackg.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/AduHulicomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Place the 3 Tigers on the fixed apex points.\nThe Goats start off the board.",
      "image": "assets/AduHulisetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Turn Order:\nThe player with the goats goes first.\nPlay alternates between the goats and the tigers.\nTiger’s Moves:\n. A tiger may move one space in any direction to an adjacent point following the lines on the board.\n. A tiger may also jump over a goat into an empty space on the opposite side, following the lines.\n. The jumped goat is captured and removed from the board.",
      "image": "assets/AduHuliplay1.svg",
      "extraImages": [
        {"image": "assets/AduHuliplay2.svg", "description": "capturing:"},
        {
          "image": "assets/AduHuliplay3.svg",
          "description":
              "Goat’s Moves\n. During the first phase, goats are placed one per turn on any unoccupied point on the board.\n. Once all 15 goats have been placed, goats may then move one space at a time along the lines of the board.\n. Goats cannot jump or capture tigers."
        },
      ]
    },
    {
      ...
      "description":
          "Goats win if they trap all tigers so none can move.\nTigers win if they capture 5 goats; beyond this, the goats cannot block the tigers effectively."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Adu Huli Aata (“Goat and Tiger Game”) is a centuries-old strategy game from Karnataka, India, symbolizing the struggle of three powerful tigers against sixteen weaker but cooperative goats. Traditionally carved into temple courtyards, it reflects themes of survival, balance, and community unity.",
                        style: TextStyle(
