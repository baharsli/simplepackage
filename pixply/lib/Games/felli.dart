...
class Felli extends StatefulWidget {
  ...
  _FelliState createState() => _FelliState();
}
...
class _FelliState extends State<Felli> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/felli-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/felli-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The goal of Felli is to capture all of the opponent’s pieces or to block them from making any valid moves, resulting in a stalemate.",
      "image": "assets/Groupothello.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/fellicolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Each player's six pieces are placed on their respective triangle, leaving the common vertex (center point) empty, as illustrated in the image.",
      "image": "assets/fellisetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Decide which player will move first, typically through mutual agreement or random means like rolling a die, with the higher number chosen.\nPlayers take turns moving one piece to an adjacent vacant point along the lines of the board.",
      "image": "assets/felli1.svg",
      "extraImages": [
        {
          "image": "assets/felli2.svg",
          "description":
              "Capturing:\n. A piece captures an adjacent opponent’s piece by leaping over it to a vacant point directly beyond, following the pattern on the board.\n. Captured pieces are removed from the board.\n. Only one piece may be used to move or capture per turn."
        },
        {
          "image": "assets/felli3.svg",
          "description":
              "Mullah Version:\n. In this variation, pieces reaching the opponent’s first-rank corners are promoted to 'Mullahs' similar to kings in Draughts. Mullahs can move any number of unoccupied spaces and capture from any distance, provided no other pieces are in between.\n. Multiple captures are allowed for Mullahs."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by capturing all the opponent’s pieces or immobilizing them so they cannot move."
    },
  ];
