...
class Zohnahl extends StatefulWidget {
  ...
  _ZohnahlState createState() => _ZohnahlState();
}
...
class _ZohnahlState extends State<Zohnahl> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Zohn ahi-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Zohn ahi-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "To move all your pieces from your starting area, around the circular path, and back to the home area while blocking your opponent's progress.",
    ...
    },
    {
      ...
      "description":
          "Each player has 1 marker to move around the track and 4 counters to represent their score.",
      "image": "assets/Zohnahlcolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "All markers begin on the starting space.\n1.Rivers\n2.Ravines\n3.Start",
      "image": "assets/Zohnahlsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players roll the die, and the highest roll determines who goes first.\nThe pieces move in opposite directions around the board and advance forward along the track with each die roll.",
      "image": "assets/Zohnahl1.svg",
      "extraImages": [
        {
          "image": "assets/Zohnahl2.svg",
          "description":
              "Movement:\nThe total number of marked symbols on the die represents how many spaces the player can move a piece.\n1=1\n2=2\n3=3\n4=6\n5=10\n6=6+another turn\nSpecial Zones:\nRivers (North and South):\n. Player must return to the starting point and loses a counter to the opponent.\nRavines (East and West):\n. The player loses their next turn.\nStarting Point:\n. All players begin their movement from this space. Completing a full circuit and passing this point earns the player a counter from the opponent.\n\n\n1.Rivers\n2.Ravines"
        },
        {
          "image": "assets/Zohnahl3.svg",
          "description":
              "Capturing :\nIf a player's piece lands on a space occupied by an opponent’s piece, the opponent’s piece is sent back to its starting position."
        },
        {
          "description":
              "Earning Counters:\n. Capturing Opponent’s Pieces: As mentioned, landing on an opponent’s piece allows you to take a counter from them.\n. Completing a Circuit: Successfully moving your piece around the entire board and returning to your starting point can also earn you a counter from the opponent."
        },
      ]
    },
    {
      ...
      "description":
          "The game ends when a player has successfully moved all their pieces around the board and back to the starting point, while earning counters by capturing the opponent’s pieces."
    },
  ];
