...
class ThreeMensMorris extends StatefulWidget {
  ...
  _ThreeMensMorrisState createState() => _ThreeMensMorrisState();
}
...
class _ThreeMensMorrisState extends State<ThreeMensMorris> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/ThreeMensMorris-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/ThreeMensMorris-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Form a row of three pieces (a “mill”) along any straight line on the board.",
      "image": "assets/ThreeMensMorrisover.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Gruopachi.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description": "The board is empty at the start.",
      "image": "assets/ThreeMensMorrisoversetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players determine who goes first, usually by random methods such as rolling a die, with the higher number deciding the starting player.\nObjective:\n. The goal of the game is to align three of your pieces in a straight line—horizontally, vertically, or diagonally. The player who achieves this wins the game.\nGameplay:\nThe game consists of two phases:\nA: Placement Phase:\n. Players take turns placing their pieces on empty spots on the board.\n. This phase continues until all pieces have been placed on the board.",
      "image": "assets/ThreeMensMorrisplay1.svg",
      "extraImages": [
        {
          "image": "assets/ThreeMensMorrisplay2.svg",
          "description":
              "B: Moving the Pieces Phase\n. Players can move their pieces only to the closest adjacent spaces that are directly connected by a line to the piece’s current position.\n. This phase continues until one player successfully forms a straight line with three of their pieces, achieving victory.\nImportant Notes:\nNo pieces are removed from the board at all. Players must play strategically to both create a line of three and block their opponent from doing so."
        },
      ]
    },
    {
      ...
      "description":
          "The first player to align all three pieces in a row (horizontally, vertically, or diagonally) wins the game."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Three Men’s Morris is an ancient two-player strategy game .Archaeological evidence shows boards carved into the roofing slabs of the temple at Kurna in Egypt (c. 1400-1333 BC), and the game has been found in many regions including the Roman Empire, China, the Philippines, Greece, and the British Isles. ",
                        style: TextStyle(
