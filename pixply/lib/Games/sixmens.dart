...
class SixMensScreen extends StatefulWidget {
  ...
  _SixMensScreenState createState() => _SixMensScreenState();
}
...
class _SixMensScreenState extends State<SixMensScreen> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
    ...
    },
    {
      ...
      "extraImages": [
        ...
        },
        {
          ...
          "description":
              "Flying Phase:\n(when a player has only three pieces left) Pieces can 'fly' to any empty point on the board, not just adjacent ones."
        }
      ]
    },
    {
