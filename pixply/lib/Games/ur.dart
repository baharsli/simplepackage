...
class UR extends StatefulWidget {
...
class _URState extends State<UR> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  String lastImagePath = 'assets/ur-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Each player aims to move all seven of their pieces along a specific path on the board and bear them off before their opponent.",
      "image": "assets/Groupothello.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/URsetup.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "The game begins with an empty board, and players start from their designated entry points.",
      "image": "assets/Groupur.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Movement:\n. A roll of 2 is required to bring a new piece into play.\n. Pieces advance along the set path.\n. A piece must reach the final space with an exact roll to exit.\nThe Role of Dice Numbers:\n. Move a piece 1 step forward.\n. Enter a new piece onto the board if available. If no pieces are off the board, move an existing piece 2 steps forward.\n. Move a piece 3 steps forward.\n. Move a piece 4 steps forward.\n. Move a piece 5 steps forward.\n. No movement (your turn is skipped).",
      "image": "assets/ur1.svg",
      "extraImages": [
        {
          "image": "assets/ur2.svg",
          "description":
              "Capturing:\n. If a roll allows a player to land exactly on an opponent’s piece (except on rosettes), that piece is captured and sent back to the start.\n. Landing on a rosette space (as shown in the path) grants an extra turn.\n. Pieces on rosettes are safe and cannot be captured.\n. If a piece is on a safe space and has no legal move, the player must pass their turn until a valid move becomes available."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by capturing all opponent’s pieces or blocking all their possible moves."
    },
  ];
