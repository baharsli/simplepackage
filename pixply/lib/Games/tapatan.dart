...
class Tapatan extends StatefulWidget {
  ...
  _TapatanState createState() => _TapatanState();
}
...
class _TapatanState extends State<Tapatan> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Tapatan-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Tapatan-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Align three of your pieces in a straight line before your opponent does.",
    ...
    },
    {
      ...
      "description": "The game begins with an empty board.",
      "image": "assets/Tapatansetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players decide who goes first, usually by a random method such as rolling a die.\nThe higher number begins.\nObjective\n. The goal is to align three of your pieces in a straight line (horizontally, vertically, or diagonally).\n. The first player to do so wins the game.\nGameplay\nPhase 1: Placement\n. Players take turns placing one piece at a time on any empty spot on the board.\n. This continues until all pieces are placed.",
      "image": "assets/Tapatanplay1.svg",
      "extraImages": [
        {
          "image": "assets/Tapatanplay2.svg",
          "description":
              "Phase B: Movement\n. After placement, players take turns moving one of their pieces.\n. A piece may move only to an adjacent connected space (along the lines of the board).\n. The game continues until a player forms a straight line of three pieces.\nImportant Notes\n. No pieces are ever removed from the board.\n. Players must balance creating their own line of three while also blocking the opponent."
        },
      ]
    },
    {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Tapatan is a traditional Filipino alignment game. It dates back to the pre-colonial era of the Philippines, likely played as early as the 16th century. The word “tapatan” means “to face each other,” reflecting the head-to-head nature of the game.",
                        style: TextStyle(
