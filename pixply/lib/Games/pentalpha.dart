...
class Pentalpha extends StatefulWidget {
  ...
  _PentalphaState createState() => _PentalphaState();
}
...
class _PentalphaState extends State<Pentalpha> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Pentalpha-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Pentalpha-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Place all nine pieces on the board by following the legal placement rules.",
      "image": "assets/Pentalphaoverview.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Pentalphacomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description": "The game starts with an empty board.",
      "image": "assets/Pentalphasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Step 1:\nPlace a piece on any vacant intersection point on the board.",
      "image": "assets/Pentalphaplay1.svg",
      "extraImages": [
        {
          "image": "assets/Pentalphaplay2.svg",
          "description":
              "Step 2:\nJump the piece over any adjacent point, following the lines, whether that adjacent point is occupied or not."
        },
        {
          "image": "assets/Pentalphaplay3.svg",
          "description":
              "step 3:\nLand the piece in the empty point beyond the one jumped."
        },
        {
          "description":
              "Sequence:\nAnyhow, if you play the right sequence of these three steps, you can get all nine pieces onto the board and win the game."
        },
      ]
    },
    {
      ...
      "description":
          "The player wins by successfully placing all nine pieces on the board according to the legal placement rules."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Pentalpha is a Greek game that appeared around the 5th century BC, during the classical era. It was often linked with the pentagram symbol, which carried mathematical and mystical meaning in Greek culture. The game is a thoughtful placement and strategy challenge.",
                        style: TextStyle(
