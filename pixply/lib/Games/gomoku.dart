...
class _GomokuState extends State<Gomoku> {
  ...
  final List<String> _imagePaths = [
    'assets/Gomoko-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Gomoko-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The goal is to align five pieces  in a row horizontally, vertically, or diagonally before the opponent does.",
      "image": "assets/Groupchess.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/gomokocolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Players use black and white pieces, similar to Go.\nStarting Position: The board begins empty.",
      "image": "assets/Gomokosetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players decide who will play as black and who as white; traditionally, black goes first.\nPlayers take turns placing one piece on an empty intersection of the board.\nThe first player to form an unbroken line(in any direction) of five pieces, without any gaps or interruptions, wins the game.",
      "image": "assets/Gameplaygomoko.svg",
    },
    {
      "title": "Winning Conditions",
      "icon": "assets/winning.svg",
      "description":
          "The game is won by the first player to achieve an unbroken line of five pieces ."
    },
  ];
