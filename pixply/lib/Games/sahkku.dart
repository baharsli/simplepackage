...
class Sahkku extends StatefulWidget {
  ...
  _SahkkuState createState() => _SahkkuState();
}
...
class _SahkkuState extends State<Sahkku> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Sahkku-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Sahkku-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Capture all of the opponent’s soldiers, or block them so they cannot move.",
      "image": "assets/Groupbackg.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Sahkkucomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Only the King (Ganagas) is placed on the center castle space.\nAll soldiers stay off the board until activated during play.\n . Barracks (side tracks) – where soldiers begin.\n . Battlefield (center tracks) – where most movement and conflict happens.\n . Castle (center space) – the king’s starting place.",
      "image": "assets/Sahkkusetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players roll the die to decide who goes first.\nNo one controls the king at the start (king piece is set aside).\nActivating Soldiers:\n. Soldiers begin “asleep” in the barracks.\n. To activate a soldier, you must roll a 1.\n. The new soldier enters at its assigned starting space nearest the king.\n. If that space is occupied, activation is delayed until it is free.\n. Once active, soldiers move according to dice rolls.\n\n\n1.Start",
      "image": "assets/Sakkutapaly1.svg",
      "extraImages": [
        {
          "image": "assets/Sakkutapaly2.svg",
          "description":
              "Die results:\n1 → Activate a soldier or move 1 step.\n2–4 → Move 2, 3, or 4 steps (same as normal rules).\n5 or 6 → Count as a 4.\nMovement Rules:\nSoldiers follow the connecting lines of the board.They continue in the same direction until:\n . They reach the far end of the track.\n . They enter their own empty entry space.\n . They meet an opposing soldier side by side."
        },
        {
          "image": "assets/Sakkutapaly3.svg",
          "description":
              "Capturing\nSoldier vs. Soldier:\n. If a piece (soldier) lands exactly on an enemy piece, that enemy is removed from the game.\nSoldier vs. King:\n. If a piece (soldier) lands on the king’s space, the king is not removed.\n. The player gains control of the king (take the king piece).\n. The capturing piece (soldier) is removed from the game."
        },
        {
          "image": "assets/Sakkutapaly4.svg",
          "description":
              "The King (Ganagas)\n . Moves and captures like a soldier.\n . May move in either direction along its path.\n . Can follow arrows to jump tracks.\n . The king is powerful but also vulnerable—control can change if another soldier captures the king’s space."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins if:\n 1.The opponent has no soldiers left, or\n 2.The opponent cannot make a legal move.\nStalemate Rule:\n . If all pieces are locked: count soldiers on the board.\n . The player with more soldiers wins.\n . If tied, the game is a draw."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Sáhkku is a traditional board game of the Sámi people in northern Scandinavia. It is played with a special three-row board, soldiers, and unique dice. The aim is to release and move soldiers around the track, capture the opponent’s pieces, and control the board.",
                        style: TextStyle(
