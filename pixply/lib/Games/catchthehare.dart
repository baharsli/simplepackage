...
class Catchthehare extends StatefulWidget {
  ...
  _CatchthehareState createState() => _CatchthehareState();
}
...
class _CatchthehareState extends State<Catchthehare> {
  ...
  final List<String> _imagePaths = [
    'assets/Catchthehare-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Catchthehare-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Catch the Hare is a game where one hare must evade being trapped by ten dogs.",
      "image": "assets/Groupchess.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/cactchgroup.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Place the hare piece at the apex of the triangular grid. Place the 10 dog pieces along the bottom row of the grid, as illustrated in the image.",
      "image": "assets/catchsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The hare always makes the first move.\nThe hare can move to any adjacent intersection, including backward moves, to evade the dogs trying to trap it.\nIn Catch the Hare, there is no 'capture' concept in the game.\nThe entire gameplay is based on movement and positioning, not removing pieces.",
      "image": "assets/catch1.svg",
      "extraImages": [
        {
          "image": "assets/catch2.svg",
          "description":
              "Dogs’ Turn: Each dog can move one step forward, sideways, or diagonally (but not backward). The goal is to collectively surround the hare and trap it."
        },
        {
          "image": "assets/catch3.svg",
          "description":
              "Important note:\nThe main goal of the hare is to survive and avoid being surrounded. If the dogs fail to trap the hare within a reasonable number of moves (usually agreed upon before the game), the hare is considered the winner."
        },
      ]
    },
    {
      ...
      "description":
          ". Hare Wins: If it escapes and remains untrapped, able to move freely without being surrounded.\n. Dogs Win: If they collectively trap the hare, leaving it unable to make any legal moves."
    },
  ];
