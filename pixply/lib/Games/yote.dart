...
class Yote extends StatefulWidget {
  ...
  _YoteState createState() => _YoteState();
}
...
class _YoteState extends State<Yote> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Yote-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Yote-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Yoté is a West African strategy game where players capture and remove their opponent’s pieces through clever jumps and tactics.",
    ...
    },
    {
      ...
      "icon": "assets/war.svg",
      "description":
          "Players take turns placing one piece on any empty intersection until all 24 pieces are placed. The player who places the last piece takes the first move.\nMovement:\n. Pieces move one step in any direction (vertically, horizontally, or diagonally) to an adjacent empty intersection.\n. A player may choose to move an already placed piece instead of placing a new one during the setup phase.\n. If an opportunity arises, a player can capture an opponent’s piece even before all pieces are placed on the board.",
      "image": "assets/yote1.svg",
      "extraImages": [
        {
          "image": "assets/yote2.svg",
          "description":
              "Capturing:\n. A piece can jump over an adjacent opponent’s piece to an empty intersection directly beyond it, capturing the opponent’s piece.\n. After a capture, the player removes one additional piece of their opponent’s choice from the board.\n. If an opportunity arises, a player can capture an opponent’s piece even before all pieces are placed on the board."
        },
        {
          "image": "assets/yote3.svg",
          "description":
              "Important note:\nMultiple jumps are allowed in a single turn if opportunities exist. For every piece captured during a single turn, the player is allowed to remove an additional opponent’s piece of their choice from the board.\nFor example:\nIf a player captures two pieces in one turn, they also get to remove two additional opponent’s pieces as a reward."
        },
      ]
    },
    {
      ...
      "description": "A player wins by capturing all of the opponent’s pieces."
    },
  ];
