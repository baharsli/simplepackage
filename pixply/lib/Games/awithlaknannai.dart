...
class Awithlaknannai extends StatefulWidget {
  ...
  _AwithlaknannaiState createState() => _AwithlaknannaiState(); // important
}
...
class _AwithlaknannaiState extends State<Awithlaknannai> {
  ...
  final List<String> _imagePaths = [
    'assets/Awithlaknannai-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Awithlaknannai-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Capture all of your opponent's pieces or block their possible moves.",
      "image": "assets/Groupchess.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/GroupAwithlaknannai.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Players place their pieces on the intersections of the row closest to them and the right half of the middle row from their perspective, leaving the central point empty, as illustrated in the image.",
      "image": "assets/Awithlaknannaisetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players determine who will go first by rolling the dice. The player with the higher roll goes first.\nThe starting player moves a piece to the central vacant point.\nMovement:\n. Players alternate turns, moving one piece to an adjacent vacant point along the lines.\n. If a capture is available, it must be made. Multiple captures in a single turn are allowed.",
      "image": "assets/Awithlaknannai1.svg",
      "extraImages": [
        {
          "image": "assets/Awithlaknannai2.svg",
          "description":
              "Capturing:\n. The opponent must capture by jumping over the adjacent piece into the empty point beyond, following the board's pattern.\n. Captures are compulsory, and multiple captures in a single turn are allowed."
        },
      ]
    },
    {
