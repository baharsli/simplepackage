...
class Seega extends StatefulWidget {
  ...
  _SeegaState createState() => _SeegaState();
}
...
class _SeegaState extends State<Seega> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/seega-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/seega-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Capture all of your opponent’s pieces by strategically surrounding them on the board.",
    ...
    },
    {
      ...
      "description":
          "Start with an empty board.\nThe central square is often marked and left empty during setup in the game.",
      "image": "assets/seegasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players alternate turns placing their pieces onto the board. Each player must place two pieces on the board at a time.\nPieces can only be placed on empty squares, excluding the central square.\nOnce all pieces are placed, the game transitions to the movement phase.",
      "image": "assets/seega1.svg",
      "extraImages": [
        {
          "image": "assets/seega2.svg",
          "description":
              "Movement:\n. The player who placed the last piece during setup goes first.\n. A piece can move one space in any direction (up, down, left, or right). Diagonal movement is not allowed.\n. A piece cannot move into or through an occupied square."
        },
        {
          "image": "assets/seega3.svg",
          "description":
              "Capturing:\nA piece is captured by sandwiching it between two of the opponent’s pieces in a straight line (horizontal or vertical).\nCaptures are mandatory if a capture is possible."
        },
        {
          "image": "assets/seega4.svg",
          "description":
              "Multiple captures are allowed in a single move if conditions permit."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by capturing all the opponent’s pieces or leaving them with no legal moves."
    },
  ];
