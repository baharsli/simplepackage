...
class _CheckersState extends State<Checkers> {
  ...
  final List<String> _imagePaths = [
    'assets/Checkers-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Checkers-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Checkers is a two-player strategy game where pieces move diagonally on a board, capturing opponents by jumping over them, with the goal to eliminate or block all opposing pieces.",
    ...
    },
    {
      ...
      "description":
          "Position the board so that each player has a dark square in their bottom left corner. Place 12 pieces on the dark squares of the first three rows closest to each player.",
      "image": "assets/checkerssetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The white pieces always start first in Checkers.\nLight pieces face dark pieces, occupying opposite sides of the board.\nPlayers take turns moving one piece diagonally forward to an adjacent empty square (there are no backward moves).",
      "image": "assets/checkers1.svg",
      "extraImages": [
        {
          "image": "assets/checkers2.svg",
          "description":
              "If an opponent's piece is on an adjacent square and there’s an empty square beyond it, the player must jump over the opponent's piece, capturing it.\nIf your piece lands after the first jump and another opponent piece is diagonally adjacent with an empty square behind it, you must jump again. You cannot stop mid-turn if more jumps are available."
        },
        {
          "image": "assets/checkers3.svg",
          "description":
              ". When a piece reaches the farthest row on the opponent's side, it is 'kinged' and can move both forward and backward diagonally.\n. If your piece lands after the first jump and another opponent piece is diagonally adjacent with an empty square behind it, you must jump again. You cannot stop mid-turn if more jumps are available.\n. Kings can move backward to better trap opponents or capture more pieces.\n. The ability to perform multiple jumps in different directions makes kings much more dangerous."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by capturing all of their opponent’s pieces or by blocking all of their opponent's moves, leaving them unable to play."
    },
  ];
