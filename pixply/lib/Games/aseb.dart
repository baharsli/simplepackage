...
class Aseb extends StatefulWidget {
  ...
  _AsebState createState() => _AsebState();
}
...
class _AsebState extends State<Aseb> {
  ...
  final List<String> _imagePaths = [
    'assets/Aseb-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Aseb-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description": "Players aim to bear off all five pieces first.",
      "image": "assets/Aseboverview.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Asebcomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Each player receives a set of five pieces which start in the off-board row, as shown.\nThese are not actual spaces on the path of the game and are not counted in movement.",
      "image": "assets/Asebsetupt.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          ". Dice & Movement:\n. On your turn, roll a six-sided die.\n. The number rolled determines how many spaces you may move.\n. Movement is always forward along the path toward the goal.\n. The first space entered counts as one from the die result.\nEntering & Movement of Pieces:\n. Unlike many similar games, pieces may be entered onto the path with any die roll.\n. On your turn, you may either:\n. Enter a new piece from your reserve onto the starting space (if it is free), or Move one of your pieces already on the path forward by the die result.\n. Both players share the central pathway.\n. Pieces move only along the pattern of spaces shown on the board.\n. Pieces can move in one direction only—always toward the goal.\n. If you can move, you must move. If no legal move exists, your turn is forfeited.",
      "image": "assets/Asebplay1.svg",
      "extraImages": [
        {
          "image": "assets/Asebplay2.svg",
          "description":
              "Occupancy and Capturing:\n. Only one piece per square is allowed.\n. Landing on a square occupied by an opponent’s piece removes their piece, sending it off the board back to their reserve."
        },
        {
          "description":
              "Safe Squares:\n. The five marked squares on the board are safe zones where pieces cannot be captured.\n. Landing on a marked square grants you an extra roll of the die.\n\n\nLeaving the Board:\nYou can only bear a piece off the board by an exact roll when on the final square.\nOnce borne off, the piece is removed from play permanently."
        },
      ]
    },
    {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Aseb is an ancient Egyptian game derived from the Royal Game of Ur. Played from around the 18th Dynasty (circa 1550 BC), it is a strategic race game for two players, where each tries to bear off all their pieces first.",
                        style: TextStyle(
