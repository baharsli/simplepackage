...
class Fivefieldkono extends StatefulWidget {
  ...
  _FivefieldkonoState createState() => _FivefieldkonoState();
}
...
class _FivefieldkonoState extends State<Fivefieldkono> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/fivefiled-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/fivefiled-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The goal of Five-Field Kono is to move all your pieces to occupy your opponent’s starting positions while blocking their progress.",
      "image": "assets/groupfivefield.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/fivefieldcolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Players place their 7 pieces on one side of the board, filling their designated starting row and the two adjacent rows, as illustrated in the image.",
      "image": "assets/Gamesetupfive.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Decide which player will move first, typically through mutual agreement or random means like rolling a die, with the higher number chosen.\nMovement :\n. Players take turns moving one piece at a time.\n. Pieces move one step diagonally to any adjacent empty space.\n. Capturing is not allowed; the game focuses purely on strategic movement and positioning.",
      "image": "assets/fivefield1.svg",
      "extraImages": [
        {
          "image": "assets/fivefield2.svg",
          "description":
              "The goal is to maneuver your pieces across the board into the opponent’s starting positions while preventing them from doing the same."
        },
      ]
    },
    {
      ...
      "description":
          "The first player to successfully move all their pieces into the opponent’s starting positions wins.\nIf neither player can complete this objective, the game ends in a draw."
    },
  ];
