...
class Konane extends StatefulWidget {
  ...
  _KonaneState createState() => _KonaneState();
}
...
class _KonaneState extends State<Konane> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/konane-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/konane-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Konane is a traditional Hawaiian strategy game often referred to as 'Hawaiian Checkers' Players aim to capture all their opponent’s pieces by jumping over them, similar to checkers, but with unique movement rules.",
      "image": "assets/Groupbackg.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/konanecolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Black and white pieces, placed alternately on all squares of the board,as illustrated in the image.",
      "image": "assets/konanesetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The player using black pieces always makes the first move. To begin, players remove one black piece and one white piece from the center or corners to create empty spaces.",
      "image": "assets/konane1.svg",
      "extraImages": [
        {
          "image": "assets/konane2.svg",
          "description":
              "Movement:\n. Pieces do not slide; they move by jumping over an adjacent opponent piece to an empty square directly beyond it.\n. Captures are mandatory and can involve multiple consecutive jumps if conditions allow.\n. All moves must be in straight lines (horizontally or vertically); diagonal moves are not allowed."
        },
        {
          "image": "assets/konane3.svg",
          "description":
              "Capturing:\n. A piece is captured by jumping over it into an empty square.\n. Captured pieces are immediately removed from the board.\n. The jump must be in a straight line (horizontally or vertically).\n. Diagonal jumps are not allowed.\n. You cannot jump over two or more consecutive pieces."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by leaving the opponent without any legal moves."
    },
  ];
