...
class Halma extends StatefulWidget {
  ...
  _HalmaState createState() => _HalmaState();
}
...
class _HalmaState extends State<Halma> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Halma-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Halma-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Halma is a strategy board game where players move pieces across a square board, aiming to occupy the opponent’s starting area. It's a test of foresight and planning, often likened to a tactical race.",
      "image": "assets/Grouphalma.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/halmacolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Place the board so each corner forms a triangular “camp.”\nPlayers arrange their pieces in a triangular formation within their starting camp (four rows: 1, 2, 3, and 4 pieces in each row).\nIn a two-player Halma game, the pieces are placed in the opposite corners of the board within their respective starting areas.\nEach player's pieces occupy a triangular formation of consecutive squares in their corner.",
      "image": "assets/setuphalma.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players agree on who goes first or decide randomly.\nMovement:\n. A piece can move to an adjacent empty square in any direction (horizontal, vertical, or diagonal).\n. A piece can also jump over another piece (own or opponent’s) to an empty square, but there is no capturing or removing pieces directly on the other side, continuing in a chain if additional jumps are possible.\n. Multiple jumps are allowed but are not mandatory.\nObjective:\nThe goal is to move all your pieces to the opponent’s starting triangle.",
      "image": "assets/Halma1.svg",
      "extraImages": [
        {
          "image": "assets/Halma2.svg",
          "description":
              "Note:\nPlayers aim to move their pieces to the opposite corner camp.\nPieces are not restricted to a straight path and can move in any direction.\nPieces must fit within the designated spaces in the target camp.\nOnce a piece reaches the target camp, it cannot leave, but it can adjust its position within the camp if needed."
        },
      ]
    },
    {
      ...
      "description":
          "The first player to move all their pieces into the opposite camp wins the game.\nIn multiplayer games, play may continue to determine second, third, and fourth places."
    },
  ];
