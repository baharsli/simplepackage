...
class MuTorere extends StatefulWidget {
  ...
  _MuTorereState createState() => _MuTorereState();
}
...
class _MuTorereState extends State<MuTorere> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/muturere-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/muturere-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Strategically block your opponent’s pieces so that they have no legal moves remaining.",
      "image": "assets/Groupothello.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/mutorerecolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Players place their 4 pieces on 4 consecutive outer points (kewai). The central point (putahi) remains empty at the start,as illustrated in the image.",
      "image": "assets/motoresetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Turn Order:\n. The game starts with one player taking the first turn. Players alternate turns thereafter.\n. On each turn, a player may move one of their pieces according to the movement rules.\n. Pieces can only move to adjacent points, either from an outer point (kewai) to the central point (putahi) or vice versa.\nMovement Rules:\nPieces can move one space in any direction, orthogonal/diagonal to an empty adjacent space. A player can only move a piece to the center point\nif:\n. The center point is vacant.\n. The player’s piece is adjacent to an opponent’s piece.",
      "image": "assets/motore1.svg",
      "extraImages": [
        {
          "image": "assets/motore2.svg",
          "description":
              "Gameplay Progression:\n. Players continue taking turns, moving their pieces strategically to block their opponent's movements or occupy key positions.\n. A player cannot skip their turn unless they have no valid moves."
        },
      ]
    },
    {
      ...
      "description":
          "The game ends when one player has no valid moves left. The other player is declared the winner.\nAlternative Victory (Optional):\nIf the game board features additional zones or scoring mechanisms, players may also win by fulfilling specific criteria (e.g., controlling the center for a certain number of turns or occupying predefined zones)."
    },
  ];
