...
class Patolli extends StatefulWidget {
  ...
  _PatolliState createState() => _PatolliState();
}
...
class _PatolliState extends State<Patolli> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Patolli-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Patolli-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Move all four of your colored pieces from your starting area around the board and into your Home area before any other player.",
    ...
    },
    {
      ...
      "description":
          "In Patolli, the number of pieces each player controls depends on the total number of participants:\n2 Players: Each player has 6 pieces.\n3 Players: Each player has 5 pieces.\n4 Players: Each player has 4 pieces.\nEach player's pieces are distinguished by color, and all pieces start off the board.",
      "image": "assets/patolicolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Each player takes six pieces of their chosen color (white and black).\nThe game begins with an empty board.",
      "image": "assets/patoli1.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Each player begins with a set of treasures, sacred offerings to the god of the game, wagered in pursuit of victory.\nMove all your pieces around the board and back to the starting space to exit successfully. The first player to remove all their pieces wins and claims the treasures.",
      "image": "assets/patoli2.svg",
      "extraImages": [
        {
          "image": "assets/patoli3.svg",
          "description":
              "Capturing :\n. If a player lands on an opponent’s piece in the central zone, they capture it.\n. The captured piece is sent back to the start and can only re-enter by rolling a 1.\n. The captured player must pay one treasure to the capturing player."
        },
        {
          "image": "assets/patoli4.svg",
          "description":
              "Special Board Rules:\nPenalty Spaces: Landing on these requires the player to offer one treasure to the god.\nCorner Bonus: If a player occupies a corner while all other corners are empty, they gain an extra turn.\nExact Count Rule: A player must roll the exact number needed to exit a piece from the board.\n\n\n1.Penalty Spaces"
        },
      ]
    },
    {
      ...
      "description":
          "The first player to remove all their pieces from the board wins. They claim all the remaining treasures offered to the gods as their prize."
    },
  ];
