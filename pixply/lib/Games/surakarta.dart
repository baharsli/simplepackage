...
class Surakarta extends StatefulWidget {
  ...
  _SurakartaState createState() => _SurakartaState();
}
...
class _SurakartaState extends State<Surakarta> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Surakarta-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Surakarta-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Capture all of your opponent’s pieces or make it impossible for your opponent to move.",
    ...
    },
    {
      ...
      "description":
          "Each player places 12 pieces in the two rows closest to them, as illustrated in the image.",
      "image": "assets/Surakartasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players decide randomly or by agreement.\nMovement Rules:\n. Pieces move one step at a time to an adjacent empty intersection, either horizontally, vertically, or diagonally.",
      "image": "assets/Surakarta1.svg",
      "extraImages": [
        {
          "image": "assets/Surakarta2.svg",
          "description":
              "Capturing:\n. To capture an opponent’s piece, a player must use the looping paths.\n. A piece travels along one of the circular paths (using the curves to change direction) and lands on an opponent’s piece to capture it. Captures can only occur if the looping path is clear of other pieces.\n. Multiple captures in a single turn are not allowed.\n. The path must be unobstructed—pieces cannot jump over other pieces on the loops or the grid.\n. Captured pieces are immediately removed from the board. A piece cannot capture if there’s no direct route (via loops) to the opponent’s piece."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by capturing all of their opponent’s pieces or leaving them without any legal moves."
    },
  ];
