...
class Ordo extends StatefulWidget {
  ...
  _OrdoState createState() => _OrdoState();
}
...
class _OrdoState extends State<Ordo> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/ordo-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/ordo-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The primary goal is to move at least one of your pieces to the opponent's home row (the row closest to them).",
      "image": "assets/Groupothello.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/ordocolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Each player starts with 20 pieces placed on the first two rows closest to them.",
      "image": "assets/ordosetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players alternate turns, with White starting the game.\nMovement:\nIn Ordo, there are two types of moves, Single Moves and Ordo Moves.\nSingle Moves:\n. A single piece can move any number of empty squares in a straight line (forward, sideways, or diagonally forward).\n. Single moves can capture opponent pieces by landing on them.\n. Backward moves are allowed only to reconnect a disconnected group.",
      "image": "assets/ordo1.svg",
      "extraImages": [
        {
          "image": "assets/ordo2.svg",
          "description":
              "Ordo Moves:\n. An 'Ordo' is a straight horizontal or vertical line of two or more connected pieces.\n. An Ordo can move together in parallel any number of empty squares (forward if horizontal, sideways if vertical).\n. Ordos cannot move diagonally and cannot capture opponent pieces.\n. You can move the entire Ordo or just a part of it, as long as the moved section remains connected."
        },
        {
          "image": "assets/ordo3.svg",
          "description":
              "Capturing :\nConditions for Capturing:\nYou can move your piece to a square occupied by an opponent’s piece. This move must be in a straight line (horizontal, vertical, or diagonal).\nSteps to Capture:\nMove your piece onto the square occupied by the opponent’s piece. Once your piece reaches that square, the opponent’s piece is removed from the board.\nRestrictions:\nOnly single moves can capture opponent pieces. Ordo moves cannot be used to capture. Pieces cannot jump over other pieces (friendly or opponent)."
        },
        {
          "image": "assets/ordo4.svg",
          "description":
              "Disconnection and Reconnection:\n. If a player's group becomes disconnected due to an opponent's capture, the player must make a move to reconnect their pieces on their next turn.\n. If reconnection is not possible, the player loses the game."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by moving at least one piece to the opponent's home row.\nAlternatively, capturing all of the opponent's pieces also results in a win.\nA player loses if their group is split by an opponent's capture and they cannot reconnect it on their next move."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Originating in Ancient Rome (circa 1st century BCE), Order Clash was a Roman strategy game played by soldiers and scholars, reflecting military formations and tactical thinking. Its exact creator is unknown, but it was a game of logic and positioning, enjoyed in Roman military camps and social gatherings.",
                        style: TextStyle(
