...
class Pahtum extends StatefulWidget {
  ...
  _PahtumState createState() => _PahtumState();
}
...
class _PahtumState extends State<Pahtum> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Pah tum-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Pah tum-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Players aim to create the longest continuous lines of their colored pieces , either horizontally or vertically, to score points.",
      "image": "assets/Groupchess.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/pattumcolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Randomly mark some squares as 'black holes' where no pieces can be placed.",
      "image": "assets/pattumsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Turns:\nPlayers alternate turns, placing one piece per turn on any vacant square that is neither occupied by another piece nor designated as a black hole.\nLine Formation:\nThe goal is to form connected lines of three or more pieces of the same color, either horizontally or vertically. Diagonal lines do not count.",
      "image": "assets/pattum1.svg",
      "extraImages": [
        {
          "description":
              "Scoring:\nPoints are awarded based on the length of each connected line at the end of the game:\n . 3 pieces = 3 points\n . 4 pieces = 10 points\n . 5 pieces = 25 points\n . 6 pieces = 56 points\n . 7 pieces = 119 points\nNote:\n . If a piece is part of both a horizontal line and a vertical line, each line is counted separately.\n . Lines of one or two stones do not score points"
        },
      ]
    },
    {
      ...
      "description":
          "The game concludes when all playable squares are occupied. The player with the higher total score wins. If both players have the same score, the game is a draw."
    },
  ];
