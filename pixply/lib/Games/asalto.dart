...
class Asalto extends StatefulWidget {
  ...
  _AsaltoState createState() => _AsaltoState();
}
...
class _AsaltoState extends State<Asalto> {
  ...
  final List<String> _imagePaths = [
    'assets/Asalto-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Asalto-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "For the Defenders (Officers): To capture or block all the attackers.\nFor the Attackers (Soldiers): To trap the defenders so they cannot move.",
      "image": "assets/Groupasalto.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/asaltocolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          ". The game is played on a rectangular board with points connected by straight and diagonal lines.\n. Attackers: 24 white pieces are placed on the lower part of the board at designated points.\n. Defenders : 2 black pieces are placed at the top of the board (castle) on their specific starting points.",
      "image": "assets/asaltosetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The attacker always makes the first move.\n\n. Attackers:\nSoldiers can move one step at a time.They may move forward, sideways, or diagonally, but only along the lines connecting the points and not backward.\n. Attackers cannot jump over any piece or capture the defenders (officers) by jumping.\nAttackers’ Goal:\n. The attackers aim to capture both defenders (officers) by surrounding them and preventing their movement. Victory is achieved when both defenders are immobilized or they capture the castle.",
      "image": "assets/asalto1.svg",
      "extraImages": [
        {
          "image": "assets/asalto2.svg",
          "description":
              "Defenders (Soldiers):\n. Soldiers can move one step in any direction (forward, backward, sideways, or diagonally) along the connecting lines.\n. Soldiers can capture attackers by jumping over them to an adjacent empty point.\n. Multiple captures in a single turn are allowed if consecutive jumps are possible.\n. In Asalto, the defenders win if they capture 15 attacker pieces."
        },
        {"image": "assets/asalto3.svg", "description": "jump:"},
        {
          "image": "assets/asalto4.svg",
          "description": "Multiple jumps and capturing:"
        }
      ]
    },
    {
      ...
      "description":
          "The defenders win if they capture enough attackers to make it impossible for them to trap the defenders. The attackers win if they trap the defenders so they cannot move or fill the castle with their pieces."
    },
  ];
