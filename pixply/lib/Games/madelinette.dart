...
class Madelinette extends StatefulWidget {
  ...
  _MadelinetteState createState() => _MadelinetteState();
}
...
class _MadelinetteState extends State<Madelinette> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Madelinette-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Madelinette-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Madelinette is a game where players aim to move their pieces strategically to block their moves.",
    ...
    },
    {
      ...
      "description":
          "Players place their pieces on the intersections of the triangular grid until all their pieces are on the board,as illustrated in the image.",
      "image": "assets/madesetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players agree on who starts or decide randomly.\nMovement:\n. Pieces move one step at a time to any adjacent empty intersection along the lines.\n. Diagonal moves are only allowed if there’s a connecting line.",
      "image": "assets/madelin1.svg",
      "extraImages": [
        {
          "image": "assets/madelin2.svg",
          "description":
              "Players aim to strategically move their pieces to block the opponent’s pieces, leaving them with no legal moves."
        },
      ]
    },
    {
      ...
      "description":
          "The player who successfully blocks the opponent completely, so they cannot make any legal moves, wins the game."
    },
  ];
