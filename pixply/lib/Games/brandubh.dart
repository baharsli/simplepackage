...
class Brandubh extends StatefulWidget {
  ...
  _BrandubhState createState() => _BrandubhState(); // important
}
...
class _BrandubhState extends State<Brandubh> {
  ...
  final List<String> _imagePaths = [
    'assets/Brandubh-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Brandubh-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Brandubh is a Viking-era strategy game from Ireland, part of the Tafl family of games. It’s an asymmetrical game where one side defends the king, trying to help him escape, while the other side attacks to capture him.",
      "image": "assets/GroupBrandubh.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Brandubhcolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "The king is placed at the center of the board. The defenders are positioned around the king in a cross formation. The attackers are placed symmetrically on the edges of the board.",
      "image": "assets/Brandubhsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The attackers always take the first move.\nMovement:\n. The central square is known as the 'throne' and is off-limits for movement. Pieces move horizontally or vertically any number of squares but cannot move diagonally.",
      "image": "assets/Brandubh1.svg",
      "extraImages": [
        {
          "image": "assets/Brandubh2.svg",
          "description":
              "Capturing:\n. A piece is captured by sandwiching it between two of the opponent’s pieces in a straight line (horizontal or vertical).\n. The king is captured if surrounded on all four sides by attackers.\n. Each move results in capturing only one piece, even if conditions allow for capturing multiple pieces in a single move.\n. If a player's piece is intentionally placed between two opponent pieces with no way to escape, it is legally captured."
        },
        {
          "image": "assets/Brandubh3.svg",
          "description":
              "The king is captured if surrounded on all four sides by attackers. It can also be surrounded by three opponent pieces and the throne square (center square)."
        },
      ]
    },
    {
      ...
      "description":
          "Defenders: The defenders win by moving the king to any of the four corners of the board.\nAttackers: The attackers win by surrounding the king on all four sides, leaving no escape for it."
    },
  ];
