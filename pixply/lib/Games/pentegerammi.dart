...
class PenteGerammi extends StatefulWidget {
  ...
  _PenteGerammiState createState() => _PenteGerammiState();
}
...
class _PenteGerammiState extends State<PenteGerammi> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/pente gerammai-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/pente gerammai-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Move all five of your checkers onto the Sacred Line before your opponent.",
      "image": "assets/Groupchess.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/pentegcolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Each player starts with their pieces placed on the center line,as illustrated in the image.",
      "image": "assets/PenteGerammisetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players decide who goes first by agreement or by rolling the die.\nMovement:\n. Players move their pieces counter-clockwise.\n. No backward movement is allowed.\n. Each turn, players roll the dice and move one piece of their choice.\n. Pieces must move to an empty space.\n. Jumping over other pieces is allowed, but landing on an occupied space is not.",
      "image": "assets/PenteGerammi1.svg",
      "extraImages": [
        {
          "image": "assets/PenteGerammi2.svg",
          "description":
              "Forced Moves & Passing Turns:\n. If at least one piece has a legal move, the player must move.\n. If no piece can legally move, the turn is skipped.\nHome Entry Rules:\n. A player can enter their home row only when all of their and their opponent's pieces are out of the home zone.\n. The home spaces are not counted as part of movement.\n. A piece at the starting position of home must move directly into the home’s endpoint.\n. If the top space of the home is occupied, no piece can exit the home."
        },
      ]
    },
    {
      ...
      "description":
          "The first player to move all their pieces to the opposite side and into their home wins the game."
    },
  ];
