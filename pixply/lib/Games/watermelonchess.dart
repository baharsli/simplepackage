...
class WatermelonChess extends StatefulWidget {
  ...
  _WatermelonChessState createState() => _WatermelonChessState();
}
...
class _WatermelonChessState extends State<WatermelonChess> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/WatermelonChess-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/WatermelonChess-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The goal is to reduce your opponent’s pieces until they have only two remaining, leaving them unable to continue effective play.",
    ...
    },
    {
      ...
      "description":
          "Pieces are placed on the board as shown in the illustration.",
      "image": "assets/WatermelonChesssetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Decide who goes first.\nMovement:\n. Players take turns moving one piece per turn.\n. A piece may move to an adjacent vacant point, following the lines on the board.",
      "image": "assets/WatermelonChessplay1.svg",
      "extraImages": [
        {
          "image": "assets/WatermelonChessplay2.svg",
          "description":
              "Capturing\n. A piece is captured when it becomes surrounded so that it cannot move.\n. The captured piece is then removed from the board.\n. Only one piece may be captured per turn.\n. Surrounding pieces may belong to either player, which means players must keep careful spacing from their own pieces while maneuvering."
        },
      ]
    },
    {
      ...
      "description":
          "The winner is the first player to reduce the opponent’s pieces to two."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Watermelon Chess, also known as Xi Gua Qi, is a traditional Chinese strategy game that has been played for centuries in rural China. Traced back to the late Qing dynasty, it remains a pure test of logic and strategy between two players.",
                        style: TextStyle(
