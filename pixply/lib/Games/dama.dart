...
class Dama extends StatefulWidget {
  ...
  _DamaState createState() => _DamaState();
}
...
class _DamaState extends State<Dama> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Dama-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Dama-game.png';
...
//image program
  ...
  final List<Map<String, dynamic>> sections = [
    ...
    },
    {
      ...
      "description":
          "Place the board between both players.\nPlayers set up their pieces on their first three rows, one piece per point.\nThe central row remains empty at the start.",
      "image": "assets/Damasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players decide who moves first. Each turn, a player moves one piece.\nMovement :\n. A piece moves one space forward along a line.\n. No backward movement for normal pieces.",
      "image": "assets/damaplay1.svg",
      "extraImages": [
        {
          "image": "assets/damaplay2.svg",
          "description":
              "Capturing\n. Captures are made by jumping over an adjacent enemy piece into an empty point beyond (short leap).\n. Multiple captures (chain jumps) are allowed and compulsory if available.\n. Backward captures are allowed.\n. All captured pieces are removed after the jump sequence ends.\n. If a capture is available, the player must take it."
        },
        {"image": "assets/damaplay3.svg", "description": "Multiple Capture :"},
        {"image": "assets/damaplay4.svg", "description": "Backward captures :"},
        {
          "image": "assets/damaplay5.svg",
          "description":
              "Flying King:\nTo show promotion, you can flip the piece or replace it with a different colored marker.\nA King can move in a straight line (forward, backward, or diagonal) across any number of empty spaces.\nA King captures by jumping over an opponent’s piece, no matter how many empty spaces are before or after it, as long as the landing space is empty.\nKings must also follow the mandatory capture rule (if they can jump, they must jump).\n\n\n1.Black becomes King"
        },
      ]
    },
    {
      ...
      "description":
          "Capture all opponent pieces or block them so they cannot move."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Dama is a traditional Turkish variant of draughts, played in Turkey since at least the 16th century. The game likely evolved from older Middle Eastern and Mediterranean draughts variants, reflecting Turkey’s role as a crossroads of cultures. It became popular as a test of strategy and patience, often played in coffeehouses.",
                        style: TextStyle(
