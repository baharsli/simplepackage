...
class _ChessState extends State<Chess> {
  ...
  final List<String> _imagePaths = [
    'assets/Chess-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Chess-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Checkmate the opponent’s king by placing it under attack in such a way that it cannot escape capture.",
    ...
    },
    {
      ...
      "description":
          "32 pieces (16 white and 16 black) including King, Queen, Rook, Bishop, Knight, and Pawn.",
      "image": "assets/Groupcolorchess.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          ". Arrange the board so that each player has a light square on the right corner.\n. Place the pieces in the back row as follows (from left to right): rook, knight, bishop, queen, king, bishop, knight, rook.\n. The pawns are placed in the row directly in front of the back pieces.",
      "image": "assets/Gamesetupchess.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "*The following gameplay is basic. To learn more advanced strategies and special rules, we recommend exploring other comprehensive resources.*",
      "extraImages": [
        {
          "image": "assets/chess1.svg",
          "description":
              "White always moves first. Pawn: Moves one square forward but captures diagonally. On its first move, it can advance two squares. Pawns are the only chess pieces incapable of moving backward."
        },
        {
          "image": "assets/chess2.svg",
          "description":
              "Rook: Moves any number of squares in a straight line horizontally or vertically."
        },
        {
          "image": "assets/chess3.svg",
          "description":
              "Knight: Moves in an 'L' shape (two squares in one direction and one square perpendicular to that). It is the only piece that can jump over other pieces."
        },
        {
          "image": "assets/chess4.svg",
          "description": "Bishop: Moves any number of squares diagonally."
        },
        {
          "image": "assets/chess5.svg",
          "description":
              "King: Moves one square in any direction. Special move: Castling."
        },
        {
          "image": "assets/chess6.svg",
          "description":
              "Queen: Moves any number of squares in a straight line (horizontally, vertically, or diagonally)."
        },
        {
          "image": "assets/chess7.svg",
          "description":
              "Players alternate turns, moving one piece per turn. A piece is captured by moving onto a square occupied by an opponent's piece, removing it from the board. The game ends in checkmate when the king is under attack and has no legal moves to escape.\n \nExample:\nIn the following...."
        },
        {
          "description":
              "Draws:\n\n. Stalemate: A player has no legal moves but is not in check.\n. Insufficient material: Neither player can checkmate (e.g., king vs. king).\n. Threefold repetition: The same board position occurs three times.\n. Fifty-move rule: If no capture or pawn move occurs in 50 consecutive moves."
        }
      ]
    },
    {
      ...
      "description": "The game is won by checkmating the opponent’s king."
    },
  ];
                                      ...
                                      children: [
                                        ...
                                        if (sections[index]['title'] ==
                                          ...
                                          if (sections[index]
                                                  .containsKey('image') &&
                                              sections[index]['image'] !=
                                                  null) // spacing between text & image
                                            Center(
                                                child: buildMedia(
                                                    sections[index]['image']!)),
                                          const SizedBox(
