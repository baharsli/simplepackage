...
class Neutron extends StatefulWidget {
  ...
  _NeutronState createState() => _NeutronState();
}
...
class _NeutronState extends State<Neutron> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Neutron-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Neutron-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Neutron is a game where players move pieces to manipulate a 'Neutron' and aim to position it on their side of the board or leave the opponent without legal moves.",
      "image": "assets/Groupothello.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/neutroncolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "The neutron is placed in the center of the board. Each player places their 5 pieces on their side of the board, filling the back row (row 1 for Player 1 and row 5 for Player 2).",
      "image": "assets/nutronsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Decide who goes first. On each turn, players move two pieces in this order:\n1.Move the neutron:\n The neutron moves in a straight line (horizontally, vertically, or diagonally) until it reaches the edge of the board or another piece.\n2.Move one of their own pieces (pieces):\nThe player's pieces move in the same manner as the neutron (straight lines until an obstacle or the board’s edge).\n\nThe first player’s first move skips the neutron and moves only one piece. Both moves are mandatory and must be made if possible. Pieces cannot jump over other pieces.",
      "image": "assets/nutron1.svg",
      "extraImages": [
        {
          "image": "assets/nutron2.svg",
          "description":
              "If the neutron lands on the last row on your side, you win the game."
        },
      ]
    },
    {
      ...
      "description":
          "he neutron ends its movement on a player’s side of the board (row 1 or row 5), or the player leaves the opponent unable to make a legal move for the neutron."
    },
  ];
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SvgPicture.asset("assets/Group.svg",
                              width: 15,
                              height: 13.75), // آیکون کاربر از assets
                          const SizedBox(width: 5),
                          const Text("2",
                              style: TextStyle(color: Colors.white)),
                        ],
