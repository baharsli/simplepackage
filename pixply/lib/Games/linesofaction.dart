...
class LOA extends StatefulWidget {
  ...
  _LOAState createState() => _LOAState();
}
...
class _LOAState extends State<LOA> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  String lastImagePath = 'assets/Loa-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Connect all your pieces into a continuous line, either vertically, horizontally, or diagonally.",
    ...
    },
    {
      ...
      "description":
          "Pieces are placed along the edges of the board: Black pieces on rows 1 and 8 (left and right edges). White pieces on columns A and H (top and bottom edges),as illustrated in the image.",
      "image": "assets/loasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Movement:\n. The number of spaces a piece moves is equal to the total number of pieces (friendly or opponent) in the straight line (horizontal, vertical, or diagonal).\n. A piece cannot move fewer spaces or stop midway.\nFor Example:\nIf there are three pieces in the chosen direction, the piece must move exactly three spaces.\n. A piece may jump over its own pieces but cannot jump over opponent pieces.\n. Landing on an opponent's piece results in its capture and removal from the board.",
      "image": "assets/loa1.svg",
      "extraImages": [
        {
          "image": "assets/loa2.svg",
          "description":
              "Capturing: A piece lands on an opponent’s piece to capture it. Captured pieces are removed from the board immediately."
        },
        {
          "image": "assets/loa3.svg",
          "description":
              "A player wins by forming all their pieces into one contiguous group, either horizontally, vertically, or diagonally."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by forming all their pieces into one contiguous group, either horizontally, vertically, or diagonally. If both players achieve this on the same turn, the game is a draw."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Invented in the United States (circa 1960) by game designer Claude Soucie, Line Clash is a two-player abstract strategy game where the objective is to connect all of one's pieces into a single group. It gained recognition after being featured in Sid Sackson's book A Gamut of Games in 1969.",
                        style: TextStyle(
