...
class ManMoon extends StatefulWidget {
  ...
  _ManMoonState createState() => _ManMoonState();
}
...
class _ManMoonState extends State<ManMoon> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/ManMoon-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/ManMoon-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Capture your opponent’s pieces until they have only one piece left.",
      "image": "assets/Groupbackg.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Groupcoloralquare.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description": "The board begins empty.",
      "image": "assets/moonsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players decide randomly who goes first.\nPhase 1: Drop Phase\n. The game begins with the Drop Phase.\n. Players alternate placing one piece at a time on any vacant space except the center.\n. When all pieces are placed, the game proceeds to the Movement Phase.",
      "image": "assets/moon1.svg",
      "extraImages": [
        {
          "image": "assets/moon2.svg",
          "description":
              "Phase 2: Movement Phase\nOpening Move\n. The first player moves one of their pieces into the center space.\n. If they cannot, the second player makes the first move.\nMovement Rules\n. Pieces move orthogonally only (no diagonals).A piece may move to an adjacent vacant point along the board’s lines."
        },
        {
          "image": "assets/moon3.svg",
          "description":
              "Custodial Capture\n. If a player moves a piece so that an opponent’s piece is sandwiched between two of their own in a straight line, the opponent’s piece is removed.\n. Captures only occur in the Movement Phase.\n. A piece may pass between opposing pieces without being captured (no suicide captures)."
        },
        {
          "image": "assets/moon4.svg",
          "description":
              "Capture Variations:\n. Multiple captures in a straight line are allowed.\n. Several opposing pieces can be captured in a single move if aligned between the capturing pieces."
        },
        {
          "image": "assets/moon5.svg",
          "description":
              ". Captures at right angles are not specified in historic rules, but are generally assumed allowed (as in similar games)."
        },
        {
          "description":
              "Blocking Rule\n. If a player is unable to move because all their pieces are blocked, the opponent continues making moves until the block is lifted and the stuck player can move again.\n. This rule also applies to the very first move of the game."
        },
      ]
    },
    {
      ...
      "description":
          "The game ends when one player is reduced to a single piece.\nThat player is humorously awarded the title “The Man in the Moon”."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "The Man in the Moon is a Victorian-era board game from England (c. 1840–1860). Inspired by English folklore about the “man’s face in the moon,” it was published as a parlor game during the rise of printed board games.",
                        style: TextStyle(
