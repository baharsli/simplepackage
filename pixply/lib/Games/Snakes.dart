...
class SnakesLadders extends StatefulWidget {
  ...
  _SnakesLaddersState createState() => _SnakesLaddersState();
}
...
class _SnakesLaddersState extends State<SnakesLadders> {
  ...
  final List<String> _imagePaths = [
    'assets/SnakesLadders-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/SnakesLadders-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description": "Be the first player to reach the final square.",
      "image": "assets/SnakesLaddersover.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/SnakesLadderscomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description": "The game starts with an empty board.",
      "image": "assets/SnakesLadderssetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The first player to roll 6 can enter the board. Each subsequent player must also throw a 6 to enter the board.\nMove your piece along the pattern on the board by the number shown on the die.",
      "image": "assets/SnakesLaddersplay1.svg",
      "extraImages": [
        {
          "image": "assets/SnakesLaddersplay2.svg",
          "description":
              "Important Rules:\n. If you land on the bottom of a ladder, immediately move up to its top.\n. If your piece lands on a red arrow, slide down to the square indicated by the arrow’s tail.\n. If you roll a 6, you may move your piece and roll again."
        },
        {
          "description":
              "Note:\nPlayers may land on a square already occupied by another player. Multiple pieces can share the same square.\nTo win, you must roll the exact number needed to land on the final square."
        },
      ]
    },
    {
      ...
      "description":
          "Be the first player to reach the final square (usually 100), rolling the exact number needed."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Snakes and Ladders originated in India around the 2nd century BCE under the name Moksha Patam. It was designed as a moral teaching tool, where ladders represented virtues leading to spiritual progress and snakes symbolized vices causing downfall.",
                        style: TextStyle(
