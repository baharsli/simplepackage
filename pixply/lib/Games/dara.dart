...
class Dara extends StatefulWidget {
  ...
  _DaraState createState() => _DaraState();
}
...
class _DaraState extends State<Dara> {
  ...
  final List<String> _imagePaths = [
    'assets/dara-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/dara-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The goal is to form an exact three-in-a-row to capture an opponent’s piece. A player wins by eliminating enough enemy pieces that the opponent can no longer form three-in-a-rows.",
    ...
    },
    {
      ...
      "description":
          "The board begins empty, and players take turns placing their pieces.",
      "image": "assets/yotesetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Decide which player will move first, typically through mutual agreement or a random method such as rolling a die, with the higher number going first. Players take turns placing one piece at a time on any empty space on the board until all pieces are placed.\nMovement:\n. After all pieces are placed, players take turns moving one piece to an adjacent empty space, either horizontally or vertically.\n. The goal is to form a horizontal or vertical row of three pieces.\n. Forming three-in-a-row during this phase is not allowed; if it happens, the third piece must be moved elsewhere.",
      "image": "assets/dara1.svg",
      "extraImages": [
        {
          "image": "assets/dara2.svg",
          "description":
              ". Capturing:\n. When a player forms a row of three pieces, they capture one of their opponent’s pieces by removing it from the board.\n. Diagonal rows do not count for capturing.\n. The player may remove any opponent’s piece that is not part of the current three-in-a-row line.\n. A piece cannot repeatedly move back and forth between two positions to form a three-in-a-row line and capture opponent’s pieces each time."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by reducing their opponent to fewer than three pieces, making it impossible for them to form a row of three."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Dara is a game from West Africa, particularly played by the Dakarkari of Nigeria and the Zarma of Niger (where it’s called Dili or Doki). Its exact origin is unknown, but the game emerged in the 19th century or earlier.",
                        style: TextStyle(
