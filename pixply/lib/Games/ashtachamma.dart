...
class AshtaChamma extends StatefulWidget {
  ...
  _AshtaChammaState createState() => _AshtaChammaState(); // important
}
...
class _AshtaChammaState extends State<AshtaChamma> {
  ...
  final List<String> _imagePaths = [
    'assets/AshtaChamma-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/AshtaChamma-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Move all of your pieces around the board and back to your home, following the track. The first player to bring all pieces safely to home wins.",
      "image": "assets/AshtaChammaoverview.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/AshtaChammacomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Each player places their 4 pieces in their “base” (starting area) as shown below.",
      "image": "assets/AshtaChammasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players take turns rolling two dice.\nA piece may enter the board only when a player rolls a 6, 12, or captures an opponent piece.\nPlayers move pieces anti-clockwise around the outer track.\n\n\nFruit house:\n. After completing a full lap, each piece must enter the inner path that leads to the center square.\n. That center square is called the fruit house (sometimes also called home or goal).\n\n\nNote: The starting home and all marked “X” squares are safe homes — opponent pieces may pass through them but cannot capture any piece resting there.",
      "image": "assets/AshtaChammaplay1.svg",
      "extraImages": [
        {
          "image": "assets/AshtaChammaplay2.svg",
          "description":
              "Movement\nPieces move anti-clockwise along the track according to the sum of both dice (2–12).\n\n\nPlayers may choose to:\n. Move one piece the full sum, or Split the dice and move two pieces separately (e.g., if the roll is 6 and 2, move one piece 6 spaces and another piece 2 spaces).\n. A square can hold only one piece; your own pieces cannot share the same square (except in the starting home)."
        },
        {
          "image": "assets/AshtaChammaplay3.svg",
          "description":
              ". To enter the center fruit house, a piece must have captured at least one opponent piece.\n. If a piece reaches the far end of the track and cannot move forward, it may only continue by making a valid sideways or backward capture.\n\n\nCapturing\n. A piece captures by landing exactly on a square occupied by an opponent’s piece.\n. Captured pieces return to their starting home.After capturing, the piece becomes eligible to enter the inner block and reach the fruit house."
        },
      ]
    },
    {
      ...
      "description":
          "The first player to move all of their pieces into the fruit house wins."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Ashta Chamma (Chowka Bhara, Ashta Chemma) is a traditional Indian race-board game for 2-4 players, combining luck (from cowrie shells or dice) and strategy. It’s old, widely played across southern and eastern India, and known by many regional names.",
                        style: TextStyle(
