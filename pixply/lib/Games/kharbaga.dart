...
class Kharbaga extends StatefulWidget {
  ...
  _KharbagaState createState() => _KharbagaState();
}
...
class _KharbagaState extends State<Kharbaga> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/kharbaga-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/kharbaga-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Capture all of your opponent's pieces or block their movement.",
    ...
    },
    {
      ...
      "description":
          "Players place their pieces alternately on the intersections of the board until all positions are filled. The center intersection remains empty at the start, as illustrated in the image.",
      "image": "assets/Kharbagasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The player who places the last piece on the board begins.\nMovement:\n. Pieces move one step at a time to adjacent empty intersections along the lines.\n. Diagonal movement is only allowed where lines connect diagonally.",
      "image": "assets/Kharbaga1.svg",
      "extraImages": [
        {
          "image": "assets/Kharbaga2.svg",
          "description":
              "Capturing:\n. A piece captures an opponent’s piece by jumping over it to an empty intersection on the other side.\n. Captures can be made in any direction (horizontally, vertically, or diagonally).\n. Multiple captures are allowed in a single turn if conditions permit."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by reducing the opponent’s pieces to two or blocking them so they cannot make a legal move."
    },
  ];
