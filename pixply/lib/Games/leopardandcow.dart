...
class LeopardCow extends StatefulWidget {
  ...
  _LeopardCowState createState() => _LeopardCowState();
}
...
class _LeopardCowState extends State<LeopardCow> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/LeopardCow-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/LeopardCow-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Leopards win by capturing at least 12 cows; Cows win by trapping both leopards so they can no longer move.",
      "image": "assets/Groupasalto.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/LeopardCowcomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "At the beginning, the cows are placed on the eight highlighted points, shown in the figure.",
      "image": "assets/LeopardCowsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Leopards enter from the triangle corners and make the first move, stepping to an adjacent empty point.\nMovement:\n. They move one step at a time.\n. Movement can be horizontal, vertical, or diagonal, but only if a line connects the two points.",
      "image": "assets/LeopardCowplay1.svg",
      "extraImages": [
        {
          "image": "assets/LeopardCowplay2.svg",
          "description":
              "Capturing:\n. A leopard captures by jumping over a single cow into the empty point directly behind it.\n. Captures follow the lines of the board (horizontal, vertical, or diagonal).\n. A leopard may capture multiple cows in one turn, but must land on an empty point after each jump."
        },
        {
          "image": "assets/LeopardCowplay3.svg",
          "description": "Multiple Captures:"
        },
        {
          "image": "assets/LeopardCowplay4.svg",
          "description":
              "Cow Movement:\n. After all cows are placed, they may move one step at a time to an adjacent empty point.\n. Movement follows the lines (horizontal, vertical, or diagonal).\n. Cows cannot jump and cannot capture. Their only goal is to trap the leopards."
        }
      ]
    },
    {
      ...
      "description":
          "If cows corner or encircle both leopards leaving no space for them to move, they win.\nThe leopards win if they capture at least 12 cows."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Leopard and Cow (Len Choa) is a Thai game first recorded in 1839 by Captain James Low. It reflects the traditional story of a lone leopard hunted by village cows, symbolizing survival, cooperation, and the balance between hunter and prey.",
                        style: TextStyle(
