...
class Picaria extends StatefulWidget {
  ...
  _PicariaState createState() => _PicariaState();
}
...
class _PicariaState extends State<Picaria> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Picaria-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Picaria-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Align your 3 pieces in a straight line (horizontally, vertically, or diagonally).",
    ...
    },
    {
      ...
      "image": "assets/Picariasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Determine who goes first by rolling a die or mutual agreement.\nMovement:\n. Players take turns placing one of their 3 pieces on any empty intersection of the board.\n. The goal during this phase is to strategically position pieces while blocking the opponent from forming a line.",
      "image": "assets/Picaria1.svg",
      "extraImages": [
        {
          "image": "assets/Picaria2.svg",
          "description":
              "After all pieces are placed, players take turns moving one piece at a time to an adjacent empty intersection.\nPieces can only move along the lines connecting the intersections."
        },
      ]
    },
    {
      ...
      "description":
          "The first player to align their 3 pieces in a straight line (horizontal, vertical, or diagonal) wins."
    },
  ];
