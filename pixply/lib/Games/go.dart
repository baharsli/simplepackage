...
class _GoState extends State<Go> {
  ...
  String lastImagePath = 'assets/go-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Control the most territory by surrounding empty intersections and capturing opponent pieces.",
      "image": "assets/Groupchess.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Gocolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description": "The board starts empty.",
      "image": "assets/Gosetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Black always plays first.\nmovement:\n. Players take turns placing one piece at a time on any unoccupied intersection on the board.\n. Placement of pieces continues until the end of the game.",
      "image": "assets/go1.svg",
      "extraImages": [
        {
          "image": "assets/Go2.svg",
          "description":
              "Capturing:\n. Pieces are captured by completely surrounding them on all orthogonal sides (left, right, top, and bottom).\n. Captured pieces are removed from the board.\nLiberties:\n. Each piece or connected group of pieces must have at least one empty adjacent intersection (liberty) to remain on the board. If all the liberties of a piece or group are occupied by opponent pieces, that piece or group is captured and removed from the board."
        },
        {
          "image": "assets/Go3.svg",
          "description":
              "Ko Rule (Preventing Repetition):\nA player cannot make a move that recreates the exact same board position from a previous turn. This prevents infinite loops."
        },
        {
          "description":
              "Scoring in Go:\n 1.Territory Scoring:\nEach player counts the number of empty spaces (intersections) completely surrounded by their stones.\nOnly fully enclosed spaces count as territory.\n 2.Captured Stones:\nPlayers count the number of opponent stones they have captured during the game.\nCaptured stones are removed from the board and added to the score.\n 3.Dead Stones:\nStones that are left on the board but cannot avoid capture are considered 'dead'.\nDead stones are added to the opponent’s score as captures and removed at the end of the game.\n 4. Komi (for White):\nTo balance the advantage of playing first, White typically receives additional points, called Komi (usually 6.5 or 7.5 points).\nFinal Scoring:\nAdd up the territory points and the captured stones for each player. Include Komi for White.\nThe player with the higher total score wins"
        },
      ]
    },
    {
      ...
      "description":
          "The game ends when both players pass consecutively, signaling that neither can make a beneficial move.\nPlayers count the empty intersections they control, plus captured stones. The player with the highest score wins."
    },
  ];
