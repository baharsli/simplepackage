...
class DablotPrejjesne extends StatefulWidget {
  ...
  _DablotPrejjesneState createState() => _DablotPrejjesneState();
}
...
class _DablotPrejjesneState extends State<DablotPrejjesne> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/DablotPrejjesne-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/DablotPrejjesne-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The objective is to capture all the opponent’s pieces or block them so they cannot move.",
      "image": "assets/ThreeMensMorrisover.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/DablotPrejjesnecomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Players face each other with their King and Prince placed at the center of the back row.\nSoldiers fill the remaining spaces of the back row.",
      "image": "assets/DablotPrejjesnesetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players decide at random (e.g. by rolling a die) to determine who makes the first move.\nMovement:\n. All pieces move one step along the connected lines to an adjacent point.\n. Soldiers may only move in the three forward directions (straight forward, forward-left, forward-right). They cannot move backward.\n. King and Prince may move one step in any direction (forward, backward, sideways, or diagonal).",
      "image": "assets/DablotPrejjesneplay1.svg",
      "extraImages": [
        {
          "image": "assets/DablotPrejjesneplay2.svg",
          "description":
              "Note:\nIf a Soldier reaches the far end of the board, it cannot move further unless it makes a sideways or backward capture.\n\n\nCapturing\n. A capture is made by leaping over an adjacent enemy piece into a vacant space directly beyond, following the lines.\n. Soldiers may capture in any direction, even though they normally move only forward.\n. Captures are mandatory for Soldiers.\n. For Kings and Princes, captures are optional."
        },
        {
          "image": "assets/DablotPrejjesneplay3.svg",
          "description":
              ". A piece may capture only an enemy of the same rank or lower.\n. Rank order: King > Prince > Soldier.\n. Chain captures (multiple jumps in one turn) are allowed — mandatory for Soldiers, optional for Kings and Princes.\n. Captured pieces are removed immediately, opening new empty spaces that can be used during the same turn."
        },
      ]
    },
    {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Dablot Prejjesne is a traditional two-player strategy board game from the Sámi people of northern Scandinavia (Sápmi), first described by outsiders in the 1800s. It represents the struggle between the Sámi (with a king, a prince, and soldiers) and landowners (landlord, son, and peasants).",
                        style: TextStyle(
