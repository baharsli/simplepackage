...
class Achi extends StatefulWidget {
  ...
  _AchiState createState() => _AchiState();
}
...
class _AchiState extends State<Achi> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Achi-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Achi-game.png';
  final ScrollController _scrollCtrl = ScrollController();
  late final List<GlobalKey> _sectionKeys = List.generate(sections.length, (_) => GlobalKey());
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Form a straight line of three of your pieces on the grid to win.",
    ...
    },
    {
      ...
      "image": "assets/achi1.svg",
      "extraImages": [
        {
          "image": "assets/achi2.svg",
          "description":
    ...
    },
    {
      ...
      "description":
          "A player wins by forming a straight line of three of their pieces horizontally, vertically, or diagonally."
    },
  ];
            ...
            WidgetsBinding.instance.addPostFrameCallback((_) {
              ...
              if (ctx != null) {
                Scrollable.ensureVisible(
                  ctx,
                  alignment: 0.0,                  // ابتدای سکشن بیاد بالای صفحه
                  ...
                  curve: Curves.easeInOut,
                        ...
                        AnimatedSize(                              // ✅ نرم‌تر شدن باز/بست
                ...
                const SizedBox(height: 30),
                // const ToolsSection(),
                const SizedBox(height:150), // Adding empty space at the bottom of the page
              ],
            ),
          ),
