...
class Choko extends StatefulWidget {
  ...
  _ChokoState createState() => _ChokoState();
}
...
class _ChokoState extends State<Choko> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/choko-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/choko-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Choko is a traditional West African strategy game where players aim to outmaneuver each other by strategically placing, moving, and capturing pieces to dominate the board.",
    ...
    },
    {
      ...
      "description":
          "Each player has six pieces of a unique color (e.g., white and black).\nThe game begins with an empty board, and players take turns placing their pieces on the board strategically.",
      "image": "assets/chokosetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players decide who plays first, usually determined by random means like rolling a die, with the higher number chosen.\nPlacement Phase:\n. Players take turns placing their pieces on empty squares.\n. The first player has the 'drop initiative' meaning both players continue placing pieces until the first player decides to move a piece instead.\n. Once a player opts to move instead of placing a new piece, the opponent can choose to continue placing or start moving their pieces.\nMovement Phase:\n. Pieces move one space (horizontally or vertically) to an adjacent empty square.",
      "image": "assets/choko1.svg",
      "extraImages": [
        {
          "image": "assets/choko2.svg",
          "description":
              "Capturing:\n. A piece can capture an adjacent opponent’s piece by jumping over it to a vacant square directly beyond (only one leap).\n. After capturing, the player removes an additional opponent’s piece of their choice from anywhere on the board, resulting in two pieces captured in a single turn."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by capturing all of the opponent’s pieces.\nIf both players are reduced to three pieces or fewer, the game is declared a draw."
    },
  ];
