...
class Alquerque extends StatefulWidget {
  ...
  _AlquerqueState createState() => _AlquerqueState();
}
...
class _AlquerqueState extends State<Alquerque> {
  ...
  final List<String> _imagePaths = [
    'assets/Alquerque-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Alquerque-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Capture all of your opponent’s pieces, or block your opponent so they cannot make any valid moves.",
    ...
    },
    {
      ...
      "description":
          "Each player begins with 12 pieces, either white or black. The pieces are arranged on all points of the first two rows and the middle row, leaving the center point vacant, as illustrated in the image.",
      "image": "assets/gamesetupalquare.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          ". Players determine who goes first, typically by a random method such as rolling a die, with the highest number winning.\n. Taking turns, each player moves one piece per turn. Pieces can move to an adjacent point connected by a line. Moves may be made vertically, horizontally, or diagonally.",
      "image": "assets/Alquerque2.svg",
      "extraImages": [
        {
          "image": "assets/Alquerque3.svg",
          "description":
              "Capturing Pieces:\n. A piece can jump over an opponent's piece into an empty point directly behind it, capturing the opponent's piece.\n. Captured pieces are removed from the board.\n. Players must move during their turn; skipping a turn is not allowed."
        },
        {
          "image": "assets/Alquerque4.svg",
          "description":
              "If a capture move is available, the player is required to make it. Moving to an empty point is not permitted when a capture opportunity exists."
        },
        {
          "image": "assets/Alquerque5.svg",
          "description":
              "Multiple jumps (chain captures) are allowed if possible in one turn."
        }
      ]
    },
    {
      ...
      "description":
          "1. The game ends when: One player loses all their pieces. One player has no legal moves left.\n2. The player who captures all opponent’s pieces or blocks all their moves wins."
    },
  ];
