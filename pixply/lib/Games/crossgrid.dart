...
class CrossGrid extends StatefulWidget {
  ...
  _CrossGridState createState() => _CrossGridState();
}
...
class _CrossGridState extends State<CrossGrid> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/CrossGrid-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/CrossGrid-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Swap the two colored sets of pieces so that each ends in the other’s starting positions.",
      "image": "assets/CrossGridoverview.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/CrossGridcomponents.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Use 16 pieces—8 of one color, 8 of another—and arrange them as shown, leaving the center point empty.",
      "image": "assets/CrossGridsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "On each turn, move one piece to an adjacent empty point along any connecting line (horizontally, vertically, or diagonally).\nIt does not matter which color or side makes the first move.",
      "image": "assets/CrossGridplay1.svg",
      "extraImages": [
        {
          "image": "assets/CrossGridplay2.svg",
          "description":
              "Jumping:\nAlternatively, you can jump over an adjacent piece into an empty point right behind it to swap places.\n\nStep 1:"
        },
        {"image": "assets/CrossGridplay3.svg", "description": "Step 2:"},
      ]
    },
    {
      ...
      "description":
          "The objective is to swap the two sets of colored pieces so that each side completely occupies the other’s starting positions."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Criss-Cross is a game that first appeared in print in France in 1697 during the reign of Louis XIV — a classic strategic pastime documented in the August 1697 issue of Mercure Galant.",
                        style: TextStyle(
