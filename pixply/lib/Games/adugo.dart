...
class Adugo extends StatefulWidget {
  ...
  _AdugoState createState() => _AdugoState();
}
...
class _AdugoState extends State<Adugo> {
  ...
  final List<String> _imagePaths = [
    'assets/Adugo-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Adugo-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The goal of Adugo is for the jaguar to capture all the dogs, while the dogs aim to trap the jaguar, preventing it from moving.",
      "image": "assets/Groupadugo.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Groupcolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Each game features one Jaguar (Black) and 14 Dogs (White).\nThe Jaguar is positioned at the center of the board, as shown in the image.\nThe Dogs are placed in all the remaining empty spaces on the grid.",
      "image": "assets/Group 60.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Game Start:\nThe game begins with the player controlling the jaguar (black).\nJaguar’s Movement Rules:\n1.The jaguar can move one step to an adjacent empty intersection in any direction—vertically, horizontally, or diagonally.",
      "image": "assets/Groupcolor1.svg",
      "extraImages": [
        {
          "image": "assets/image 6.svg",
          "description":
              "2.Jump to Capture: The jaguar can jump over a dog to an empty space directly on the other side, capturing the dog and removing it from the board.\n\n3.Multiple Captures: The jaguar can capture multiple dogs in a single turn by executing consecutive jumps, provided there is an empty space after each dog being jumped over."
        },
        {
          "image": "assets/image 7.svg",
          "description":
              "2.Dogs’ Movement Rules:\n1.Dogs can move one step to an adjacent empty intersection, either vertically, horizontally, or diagonally (if connected by a line).\n2.Dogs cannot jump over the jaguar or other dogs.\n3.The objective for the dogs is to trap the jaguar and restrict its movement."
        },
      ]
    },
    {
      ...
      "description":
          "Jaguar Wins: The jaguar wins by capturing a minimum of five dogs from the board.\nDogs Win: The dogs win by trapping the jaguar, blocking all its possible moves."
    },
  ];
