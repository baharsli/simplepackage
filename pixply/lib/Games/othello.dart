...
class _OthelloState extends State<Othello> {
  ...
  final List<String> _imagePaths = [
    'assets/othello-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/othello-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The objective is to strategically dominate the board by the end of the game, ensuring that the majority of the discs display your color.",
      "image": "assets/Groupothello.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Groupcolorothello.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "The board starts with four pieces placed in the center. One player is assigned black, and the other white.",
      "image": "assets/Gamesetupothello.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          ". Players take turns placing a piece of their color on the board.\n. Pieces placed on the board remain stationary; they cannot be moved once placed.\n. The black player always makes the first move.\n\nGoal:\nCapture one or more of the opponent’s pieces by flanking them in a straight line—horizontally, vertically, or diagonally. Once flanked, the captured pieces should change to the capturing player’s color.\n\n. If a player cannot flank at least one of the opponent’s pieces with their move, they are not allowed to place their piece on the board for that turn. In such cases, the player must pass their turn.\n. Capturing one or more of the opponent’s pieces is only possible during the placement of a piece. Subsequent changes, such as changing a captured piece to your color, cannot create additional flanks or capture new pieces. Only the initial placement determines the captures.\n\n\n1.First move",
      "image": "assets/othello1.svg",
      "extraImages": [
        {
          "image": "assets/othello2.svg",
          "description":
              "Flanked, captured, and changed to the capturing player’s color."
        },
        {"image": "assets/othello5.svg", "description": "1.Secend move"},
        {
          "image": "assets/othello4.svg",
          "description":
              "Capturing Multiple Pieces:\n. Players can capture more than one of the opponent’s pieces in a single turn, provided they are flanked between the newly placed piece and another piece of the player’s color.\n. Capturing can occur in multiple directions at the same time (horizontal, vertical, or diagonal), and all flanked pieces in these directions are flipped to the player’s color.\n. There is no limit to the number of pieces that can be captured in a single turn, as long as they meet the capturing condition."
        },
        {
          "image": "assets/othello3.svg",
          "description":
              "Note:\nPlacing a single piece can flank one or more of the opponent’s pieces in one or more directions, capturing all the flanked pieces in those directions."
        }
      ]
    },
    {
      ...
      "description":
          "The player with the most pieces of their color on the board at the end wins. If both players have the same number of pieces, the game is a draw.\n\nExeptions:\n. A move is invalid if it does not result in at least one opponent’s piece being flipped.\n. Passing is only allowed when no valid moves are available.\n. The corners of the board are strategically powerful, as pieces placed there cannot be flipped."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Originally inspired by the ancient Norse game Hnefatafl, Reversi was officially invented in Japan in 1971 by Goro Hasegawa, transforming into a globally recognized strategy game of flipping and domination, now played competitively worldwide.",
                        style: TextStyle(
