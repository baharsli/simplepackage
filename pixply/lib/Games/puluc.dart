...
class Puluc extends StatefulWidget {
  ...
  _PulucState createState() => _PulucState();
}
...
class _PulucState extends State<Puluc> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Puluc-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Puluc-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Capture the opponent’s pieces by landing on their occupied spaces and bringing them back to your home base to score points.",
      "image": "assets/Groupchess.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/puluccolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Players use black and white pieces, placed in their respective home base rows, as illustrated in the image (similar to Go).\nStarting Position: The board begins empty.",
      "image": "assets/pulucsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players take turns rolling the dice . The player with the higher roll goes first.\nMovement:\n. Players move their pieces forward by the number rolled on the dice.\n. A piece can only move forward and must follow the track.\n. A piece cannot land on a space already occupied by the player’s own pieces.\n. Players may choose how many pieces to introduce into play.",
      "image": "assets/puluc1.svg",
      "extraImages": [
        {
          "image": "assets/puluc2.svg",
          "description":
              "Capturing:\n. If a player lands on a space occupied by an opponent’s piece, that piece is captured and placed beneath the capturing piece, becoming a 'prisoner'.\n. Once a piece is captured, it must be carried back to your home base to score points."
        },
        {
          "image": "assets/puluc3.svg",
          "description":
              "Multiple Capture:\nIn a multiple capture move, a piece can only land on a space if it alternates between a stack of captured pieces (prisoners) and opponent pieces, ensuring no consecutive landings on the same type."
        },
        {
          "description":
              "Winning in Puluc:\n. Continued Movement of Pieces: Pieces continue their movement even after capturing an opponent or freeing prisoners, until they reach their destination.\n. Elimination of Captured Pieces: If a piece or a group of captured prisoners reaches the opponent’s starting area, all the captured pieces are permanently removed from the game.\n. Returning the Capturing Piece: The piece that successfully delivers the prisoners to the opponent’s starting area returns to its own starting position to re-enter the game and continue playing."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by eliminating all of the opponent’s pieces from the game."
    },
  ];
