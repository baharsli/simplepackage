...
class _TablePageState extends State<TablePage> {
  ...
  final List<String> _imagePaths = [
    'assets/Tableofthefourseason-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Tableofthefourseason-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Be the first player to move all 12 of your pieces around the track and safely bear them off.",
      "image": "assets/TablePageoverview.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/componenttable.svg",
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "The game begins with an empty track. Each player takes the pieces for one season and places them in their own quadrant.\n. Green = Spring\n. Red = Summer\n. Blue = Autumn\n. Yellow = Winter",
      "image": "assets/Tablesetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Entry Rules:\n . To place your first piece on the track, you must roll a double (e.g. 1-1, 6-6).\n . If you don’t roll a double when it’s your turn, your entry is delayed until a later turn when you do roll one.\n . Once your first piece is on the board, you may enter additional pieces using any valid dice roll (not necessarily double).\n . Entry is always to the first space of your season’s starting quadrant (the space adjacent to your season).\n\nMovement :\n . After all 12 pieces have been entered by each player,movement around the track begins.\n . Turns proceed in season order (Spring → Summer → Autumn → Winter) clockwise.",
      "image": "assets/playtable1.svg",
      "extraImages": [
        {
          "image": "assets/playtable2.svg",
          "description":
              "Each die can be used separately: you can move one piece by the number shown on one die, and another piece by the number shown on the other die (or both dice may be combined on a single piece if rules allow).\nExample:\nIf the dice show 1 and 2 → the player may move one token 3 spaces forward, or move one token 1 space and another token 2 spaces.\nNote:Pieces cannot enter an opponent’s quadrant if the target space is already occupied. But within your own quadrant, any number of your pieces can move freely ."
        },
        {
          "image": "assets/playtable3.svg",
          "description":
              "Capturing\n. If your token lands on a space occupied by a single opponent’s token, that token is captured and sent back to its starting area.\n. You cannot land on spaces occupied by two or more opponent pieces—those are blocked.\n. A piece can only be entered onto the board by rolling a double (e.g. 1-1 or 6-6)."
        },
        {
          "image": "assets/playtable4.svg",
          "description":
              "Safe Zones:\nThe four boundary points where the seasonal quadrants meet are designated as safe zones.  Tokens on these spaces cannot be captured."
        },
      ]
    },
    {
      ...
      "description":
          "The winner is the first player to move all of their tokens once around the board and into their home area."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "El Mundo, also known as the Table of the Four Seasons, comes from King Alfonso X’s Libro de los Juegos (Book of Games), a medieval Spanish manuscript completed in 1283. The game combines chance, strategy, and symbolism, reflecting medieval views of time, nature, and fortune.",
                        style: TextStyle(
