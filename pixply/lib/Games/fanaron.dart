...
class Fanaron extends StatefulWidget {
  ...
  _FanaronState createState() => _FanaronState(); // ✅ important
}
...
class _FanaronState extends State<Fanaron> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Fanaron-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Fanaron-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Fanorona is a captivating strategy game from Madagascar, played with 22 pieces per player, the goal is to outsmart your opponent through tactical captures and dynamic moves, making it a thrilling battle of wits.",
      "image": "assets/Groupadugo.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/colorfanaron.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Players place their 22 pieces on their respective sides of the board, filling the first two rows completely and alternating pieces with the opponent on the middle row, leaving the center point empty, as illustrated in the image.",
      "image": "assets/setupfanaron.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The first move is traditionally made by the player controlling the white pieces.\nMovement: \n. Players take turns moving one piece along a line to an adjacent empty point.\n.  Moves can be horizontal, vertical, or diagonal, following the lines on the board.",
      "image": "assets/fanarona1.svg",
      "extraImages": [
        {
          "image": "assets/fanaron2.svg",
          "description":
              "Objective:\nThe goal is to capture all of your opponent’s pieces. Each captured piece must be removed from the board. Capturing is mandatory whenever a capture is possible.\nCaptures can be made in two ways:\n. Approach:\nMoving your piece to a position directly adjacent to an opponent’s piece along a line, capturing it.\n. You can only capture through an approach if the move results in no empty space between your piece and the opponent’s piece after the move.\nExample:\nIf your piece moves directly adjacent to a row of two opponent’s pieces in a straight line, both opponent’s pieces are captured."
        },
        {
          "image": "assets/fanaron3.svg",
          "description":
              "Withdrawal:\n. Moving your piece away from an adjacent opponent’s piece along a line, capturing it.\n. You can only capture through a withdrawal if the move creates exactly one empty space between your piece and the opponent’s piece after the move."
        },
        {
          "image": "assets/fanaron4.svg",
          "description":
              "Multiple Captures:\nYou can capture pieces consecutively if your initial move results in a capture and creates an opportunity for the same piece to capture again in subsequent moves. You may continue capturing multiple times as long as such opportunities exist. However, you are not allowed to revisit any spaces you have already occupied during this sequence.\n \nBelow is an example of a three-step multiple capture performed by the white piece against the black pieces. In each step, the white piece creates an opportunity to make an additional capture with a single move, resulting in a chain of consecutive captures."
        },
      ],
    },
    {
      ...
      "description":
          "A player wins by capturing all of the opponent’s pieces.\nIf neither player can achieve this, the game is declared a draw."
    },
  ];
  bool? isLiked = false;
