...
class Agon extends StatefulWidget {
  ...
  _AgonState createState() => _AgonState();
}
...
class _AgonState extends State<Agon> {
  ...
  final List<String> _imagePaths = [
    'assets/Agon-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Agon-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Be the first to get your queen to the throne (center hex) and surround her with all six of your guards.",
      "image": "assets/Groupbackg.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Agoncomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "The pieces are placed on the board as shown below, and certain key spaces are left empty.",
      "image": "assets/Agonsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Decide who goes first.\nTurn-based: Players move one piece per turn.\nStep size: Each piece (queen or guards) moves one hex per turn.\nDirections of movement:\n1. To an adjacent hex around the same ring (sideways movement).",
      "image": "assets/Agonplay1.svg",
      "extraImages": [
        {
          "image": "assets/Agonplay2.svg",
          "description": "2. To the next inner ring (towards the center)."
        },
        {
          "image": "assets/Agonplay3.svg",
          "description":
              "Note:\n. You cannot move into an occupied hex.\n. You cannot jump over other pieces.\n. Movement must follow the marked hex lines on the board.\n. You can only move backward if your opponent surrounds you and forces you to relocate.\n\n\nCapturing:\n. Pieces are captured by the custodian (flanking) method when an opponent’s piece is trapped between two of yours in a straight line.\n. Captured pieces are not removed from the board. Instead, the captured player must use their next turn to relocate that piece.\n. You can only move backward if your opponent surrounds you and forces you to relocate."
        },
        {
          "image": "assets/Agonplay4.svg",
          "description":
              "Queen rules:\nIf the captured piece is a Queen, it may be moved to any vacant hex on the board."
        },
        {
          "image": "assets/Agonplay5.svg",
          "description":
              "Multi-Capture:\n. If a move results in capturing more than one piece in the same turn, the captured pieces must be relocated one per turn.\n. If one of the captured pieces is the Queen, it must be moved first.\n. If the capturing piece moves away before the captured pieces have been relocated, the capture is broken and the forced-move requirement is cancelled."
        },
        {
          "description":
              "Special Rules:\n. If the capturing piece moves away before all captured pieces have been relocated, the capture is broken and the forced-move requirement is cancelled.\n. Any empty hex between two pieces of the same player is off limits to the opponent. This is an omnidirectional rule, applying in all directions.\n. For strict play: once a piece is touched, that is the piece that must be moved.\n. No takebacks are allowed — if you touch a piece and then change your mind, you lose the move."
        },
      ]
    },
    {
      ...
      "description":
          "The winner is the first player to move their Queen to the central hex (the throne) and surround her with all six guards."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Agon was invented in England by Anthony Peacock in 1842. Though some sources suggest French origins in the late 1700s, its definitive publication places it firmly in the mid-19th century. It’s a deep strategy game for two players.",
                        style: TextStyle(
