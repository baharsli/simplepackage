...
class PatGonu extends StatefulWidget {
  ...
  _PatGonuState createState() => _PatGonuState();
}
...
class _PatGonuState extends State<PatGonu> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/pat Gonu-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/pat Gonu-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Pat Gonu is a traditional game where two players use three pieces each to outmaneuver their opponent. The goal is to strategically position your pieces to block your opponent's moves, leaving them unable to play.",
      "image": "assets/Groupchess.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Grouppatgonu.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Players use black and white pieces, as shown in the illustration below.",
      "image": "assets/patgonusetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Decide the first player by rolling a die or mutual agreement.\nPlayers take turns moving one of their pieces along the lines to an adjacent empty point .\nBackward movements are not allowed. Once a piece moves forward from its starting line, it cannot return to that line.",
      "image": "assets/patgonu1.svg",
      "extraImages": [
        {
          "image": "assets/patgonu2.svg",
          "description":
              "In Pat Gonu, capturing or removing opponent pieces is not allowed. The goal is to block your opponent's pieces, preventing them from making any legal moves."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by positioning their pieces in such a way that the opponent cannot move any of their pieces."
    },
  ];
