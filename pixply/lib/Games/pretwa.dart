...
class Pretwa extends StatefulWidget {
  ...
  _PretwaState createState() => _PretwaState();
}
...
class _PretwaState extends State<Pretwa> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Pretwa-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Pretwa-game.png';
...
// }
  ...
  final List<Map<String, dynamic>> sections = [
    ...
    },
    {
      ...
      "description":
          "At the start, each player places 9 pieces on their half of the board, opposite each other.\nThe center point remains empty at the beginning.",
      "image": "assets/Pretwasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Black always moves first, taking one step to an adjacent empty point.\nMovement:\n. Players move one piece per turn.\n. A piece moves one step to an adjacent empty point.\n. Movement can follow the circular lines or the radial lines of the board.",
      "image": "assets/Pretwaplay1.svg",
      "extraImages": [
        {
          "image": "assets/Pretwaplay2.svg",
          "description":
              "Capturing\n. A capture is made when a piece jumps over an adjacent opponent’s piece to the empty point directly beyond it, following a line.\n. Multiple captures are allowed in a single turn if each jump lands on an empty point.\n. Captured pieces are removed from the board immediately."
        },
        {
          "image": "assets/Pretwaplay3.svg",
    ...
    },
    {
      ...
      "description":
          "A player wins by trapping all opponent’s pieces, making the last move, or having more pieces if the game is blocked."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Pretwa is a traditional alignment and capture game from India, originating in the Bihar region. The name comes from the Sanskrit word prastara, meaning “spread out.” It was a popular village pastime, valued for its simple rules but deep strategic possibilities.",
                        style: TextStyle(
