...
class DuploDraughts extends StatefulWidget {
  ...
  _DuploDraughtsState createState() => _DuploDraughtsState(); // ✅ important
}
...
class _DuploDraughtsState extends State<DuploDraughts> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Duplo Draughts-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Duplo Draughts-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Capture all of the opponent's pieces or block them so they cannot make any legal moves.",
    ...
    },
    {
      ...
      "description":
          "Players place their pieces on alternating squares of the three rows closest to them, starting with the second row. Each player has a dark square at their bottom left corner.",
      "image": "assets/Duplo Draughtssetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Determine who goes first by rolling a die or mutual agreement.\nMovement:\n. Players take turns moving pieces diagonally forward one square at a time to an empty square.\n. Pieces cannot move backward unless promoted to a king.",
      "image": "assets/Duplo Draughts1.svg",
      "extraImages": [
        {
          "image": "assets/Duplo Draughts2.svg",
          "description":
              "King Rules:\n. When a piece reaches the opponent’s back row (last rank), it is promoted to a king.\n. Kings are marked by stacking an additional piece on top.\n. Kings can move diagonally both forward and backward, one square at a time.\n. Kings can capture by jumping over opponent pieces in any diagonal direction."
        },
        {
          "image": "assets/Duplo Draughts3.svg",
          "description":
              "Capturing:\nA player can capture an opponent’s piece by jumping diagonally over it into an empty square. Captured pieces are placed underneath the capturing piece, forming a stack that represents control and adds complexity."
        },
        {
          "image": "assets/Duplo Draughts4.svg",
          "description":
              "Multiple Capturing:\nIf a piece can make multiple captures in one turn by jumping over multiple opponent’s pieces, it must do so."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by capturing all the opponent’s pieces or leaving them without any legal moves."
    },
  ];
