...
class Latrunculi extends StatefulWidget {
  ...
  _LatrunculiState createState() => _LatrunculiState();
}
...
class _LatrunculiState extends State<Latrunculi> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Latrunculi-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Latrunculi-game.png';
...
//عکس
  ...
  //     // await _bluetooth.deleteAllPrograms();
  //     // await _bluetooth.updatePlaylistComplete();
  //     await _bluetooth.setRotation(RotationStore.selectedRotation); // اضافه شود
  //     await Future.delayed(
  //         const Duration(milliseconds: 300)); // کمی تاخیر برای اطمینان
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Capture all your opponent’s pawns or immobilize their Dux (King piece) by surrounding it on all sides.",
      "image": "assets/Latrunculigrup.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/GroupLatrunculi.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Players place their pieces on two opposing sides of the board, filling the first row.\nThe central squares are left empty for movement and strategy. The Dux is placed in the center of the back row, as illustrated in the image.",
      "image": "assets/Latrunculisetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Movement:\n. Pieces can move an unlimited number of spaces in a single turn but only in a straight line (horizontally or vertically).\n. A piece must stop at the first empty space or when it encounters another piece (friendly or opponent). Pieces cannot jump over other pieces.\n. Moves must follow the grid lines and end at an empty space.\n. If a friendly piece is in the path, the moving piece is stopped and cannot proceed further.",
      "image": "assets/Latrunculi1.svg",
      "extraImages": [
        {
          "image": "assets/Latrunculi2.svg",
          "description":
              "Movement of the Dux (King):\n. It moves in the same way: unlimited spaces in a straight line but cannot pass through or over other pieces.\n. The Dux is used to block the opponent's movements strategically.\n. It cannot be captured, making it a safe and stable piece throughout the game.\n. A piece sandwiched between the Dux and a regular piece is not captured."
        },
        {
          "image": "assets/Latrunculi3.svg",
          "description":
              "Capturing:\n. A piece is captured by sandwiching it between two of your pieces in a straight line (either horizontally or vertically).\n. Multiple captures can be made in a single turn if the moves are valid.\nExample:\nIf your piece moves in such a way that it ends up at the end of a horizontal or vertical line of multiple opponent pieces, all of those pieces are captured simultaneously and removed from the board."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins by capturing all of the opponent's pieces or leaving them unable to make any legal moves."
    },
  ];
