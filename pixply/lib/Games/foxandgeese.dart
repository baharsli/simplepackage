...
class _FoxState extends State<Fox> {
  ...
  String lastImagePath = 'assets/fox-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Fox and Geese is a traditional strategy game from medieval Europe. One player controls a fox attempting to capture geese, while the other controls a flock of geese working together to trap the fox.",
      "image": "assets/Groupothello.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/foxcolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "One fox piece starts in the center of the board.\nThirteen geese pieces are placed on designated points near the edges of the board, as illustrated in the image.",
      "image": "assets/foxsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The player controlling the geese pieces typically goes first.\nGeese Moves.\n. Each goose piece can move one step to an adjacent empty point. They cannot jump or capture the fox.\n. The geese pieces cannot move backward.\n. The geese work collectively to corner the fox piece and restrict its movements.",
      "image": "assets/fox1.svg",
      "extraImages": [
        {
          "image": "assets/fox2.svg",
          "description":
              "Fox Moves:\n. The fox can move to any adjacent point along the lines or jump over an adjacent goose to an empty point beyond, capturing the goose.\n. Multiple jumps and captures are allowed in a single turn if possible."
        },
        {
          "image": "assets/fox3.svg",
          "description":
              "To capture the fox, the geese must work together to trap it in a position where it has no legal moves"
        },
      ]
    },
    {
      ...
      "description":
          "Fox Wins: if the fox piece captures enough geese pieces to make it impossible for them to trap it.\nGeese Win: if the geese pieces trap the fox piece so that it has no legal moves."
    },
  ];
