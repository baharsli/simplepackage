...
class Hyenachase extends StatefulWidget {
  ...
  _HyenachaseState createState() => _HyenachaseState();
}
...
class _HyenachaseState extends State<Hyenachase> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Hyena chase-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Hyena chase-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Hyena Chase is a traditional African race game where players guide their 'mothers' from the village to the well and back, aiming to be the first to return safely.",
      "image": "assets/heyenagroup.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/GroupHyenachase.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "The board starts empty. Each player has one distinct piece called a 'mother'.",
      "image": "assets/Hyenachasesetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "All mothers start outside the game track. Players must roll the dice (usually a 6) to bring each mother onto the track.\nThe hyena also starts outside the game track and only enters the game after the main race is completed (when a player wins).\nEach mother must reach the well and return to the village to win the game.",
      "image": "assets/Hyenachase1.svg",
      "extraImages": [
        {
          "image": "assets/Hyenachase2.svg",
          "description":
              "Movement:\nOnce on the track, mothers move forward based on the die roll:\n. Rolls of 1 to 6 allow movement of the corresponding number of spaces.\n. Multiple mothers can occupy the same space.\nReaching the Well:\n. Mothers must reach the well by an exact roll.\n. If the exact roll is not achieved, the turn passes to the next player.\n. Upon arrival, mothers must roll a 6 to begin the return journey.\nReturning to the Village:\n. The return journey also requires exact rolls to reach the village.\n. The first mother to return to the village wins the game.\nIntroducing the Hyena:\n. The hyena enters the track after a player returns their mother to the village.\n. After a player wins, they release the hyena onto the track by rolling a 6.\nThe hyena moves at double the rate of mothers: Rolls of 1 to 6 translate to 2 to 12 spaces, respectively."
        },
        {
          "image": "assets/Hyenachase3.svg",
          "description":
              "The hyena must reach the well by an exact roll and roll a 6 to begin its return journey.\nOn its return, any mother it overtakes is 'eaten' and removed from the game.\nHowever, if a mother jumps over or passes the hyena during its movement, the hyena is not captured and remains in play."
        },
      ]
    },
    {
      ...
      "description":
          "The first player to successfully return all their pieces to the village is the winner."
    },
  ];
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  SvgPicture.asset(
                                    sections[index][
                                        'icon'], // اینجا از آیکون مربوط به هر بخش استفاده می‌کنیم
                                    width: 32,
                                    height: 32,
                                  ),
                                  const SizedBox(
