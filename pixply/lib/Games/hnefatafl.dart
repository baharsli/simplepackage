...
class Hnefatafl extends StatefulWidget {
  ...
  _HnefataflState createState() => _HnefataflState();
}
...
class _HnefataflState extends State<Hnefatafl> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Hnefatafi-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Hnefatafi-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Hnefatafl, known as 'The King's Table' is an ancient Norse strategy game featuring asymmetrical\nsides: defenders protecting their king and attackers aiming to capture him.",
      "image": "assets/Groupchess.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Hnefataflcolor.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "1.The king is placed at the center of the board.\n2.Defenders surround the king in a cross pattern.\n3.Attackers are placed symmetrically on the edges of the board.\n4.The four corner squares are the king’s escape points, as illustrated in the image.",
      "image": "assets/Hnefataflsetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Attackers make the first move.\nMovement:\n. All pieces move horizontally or vertically any number of squares, similar to a rook in chess.\n. Pieces cannot jump over other pieces.\nImportant note:\n. The central square (throne) and corner squares are restricted; only the king can occupy them.",
      "image": "assets/Hnefatafl1.svg",
      "extraImages": [
        {
          "image": "assets/Hnefatafl2.svg",
          "description":
              "Capturing:\n. A piece is captured if an opponent's pieces occupy both adjacent squares on opposite sides (sandwiching) along a row or column. Captured pieces are removed from the board.\n. A piece cannot move between two enemy pieces and remain there; it must pass through without stopping to avoid being captured."
        },
        {
          "image": "assets/Hnefatafl3.svg",
          "description":
              "A piece that ends its move between an enemy piece and the king's throne (central square) will be captured.\nSimilarly, if a piece ends its move between an enemy piece and one of the four corner squares (escape points), it will also be captured due to being sandwiched."
        },
        {
          "image": "assets/Hnefatafl4.svg",
          "description":
              "If the king is surrounded on all four sides by enemy pieces or trapped between an enemy piece and one of the corner squares (escape points), he is considered captured and removed from the game."
        },
      ]
    },
    {
      ...
      "description":
          "Defenders win if the king escapes to any of the corner squares. Attackers win if the king is captured before he escapes."
    },
  ];
