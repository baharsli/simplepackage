...
class Rimau extends StatefulWidget {
  ...
  _RimauState createState() => _RimauState();
}
...
class _RimauState extends State<Rimau> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/rimu-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/rimu-game.png';
...
//image program
  ...
  final List<Map<String, dynamic>> sections = [
    ...
    },
    {
      ...
      "image": "assets/riucomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Each player places all 16 of their pawns on their side of the board:\n. Fill the first two rows completely.\n. Place pieces on the two corner points of the third row.",
      "image": "assets/riusetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Decide randomly who moves first.\nMovement:\n. Players take turns moving one piece at a time.\n. A piece may move one step along a line to an adjacent empty point.\n. Movement is allowed in all directions: forward, backward, sideways, or diagonally, as long as the points are connected by a line.",
      "image": "assets/rimuplay1.svg",
      "extraImages": [
        {
          "image": "assets/rimuplay2.svg",
          "description":
              "Capturing\n. To capture, a piece jumps over an adjacent opponent’s piece into the empty point directly beyond it (similar to checkers).\n. Captures are allowed in any direction: forward, backward, sideways, or diagonal."
        },
        {
          "image": "assets/rimuplay3.svg",
          "description":
              "Multiple captures:\n. Multiple captures are allowed in a single turn if available.\n. Captured pieces are removed immediately from the board.\n. Capturing is mandatory whenever possible."
        },
      ]
    },
    {
      ...
      "description":
          "A player wins if they:\nCapture all opponent pieces, or Block the opponent so no legal moves remain."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Rimau, or Harimau, is a traditional Malaysian strategy game dating back centuries. One tiger faces multiple villagers, symbolizing survival and cunning in rural life. It’s a pure game of strategy and tactics, with no element of chance.",
                        style: TextStyle(
