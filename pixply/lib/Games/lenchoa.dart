...
class LenChoa extends StatefulWidget {
  ...
  _LenChoaState createState() => _LenChoaState();
}
...
class _LenChoaState extends State<LenChoa> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/LenChoa-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/LenChoa-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The tiger wins by capturing leopards; the leopards win by trapping the tiger.",
      "image": "assets/Groupbackg.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/LenChoacomponent.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          "Place the Tiger on the apex point of the triangle.\nAll six Leopards start off the board.",
      "image": "assets/LenChoasetup.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "The Leopards move first.\nPlayers then alternate turns: Leopards → Tiger, and so on.\nTiger’s Turn\nOn its turn, the tiger may:\n. Move to an adjacent empty point along the lines of the board.\n. Capture a leopard by jumping over it to the next empty point in a straight line (similar to Checkers).\n. Only one leopard can be jumped at a time.\n. Captured leopards are removed from the board.",
      "image": "assets/LenChoaplay1.svg",
      "extraImages": [
        {
          "image": "assets/LenChoaplay2.svg",
          "description":
              "Leopard’s Turn\n. On their turn, the leopard player places one piece onto any empty point on the board.\n. Leopards continue placing until all six pieces are on the board.\nOnce all are placed, leopards may move:\n. A piece may move to an adjacent empty point along the lines of the board.\n. Leopards cannot jump or capture.\nNote: Leopards cannot move until all six pieces have entered the board."
        },
      ]
    },
    {
      ...
      "description":
          "The Tiger wins if it captures 3 pieces, because the remaining 3 cannot trap it.\nThe Leopards win if they trap the tiger so that it cannot move or capture."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Len Choa is a traditional Thai strategy game dating back to at least the 19th century. It is an asymmetric hunt game: one tiger faces six leopards. The tiger tries to capture the leopards, while the leopards try to trap the tiger so it cannot move.",
                        style: TextStyle(
