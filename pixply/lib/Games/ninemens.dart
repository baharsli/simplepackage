...
class NineMens extends StatefulWidget {
  ...
  _NineMensState createState() => _NineMensState();
}
...
class _NineMensState extends State<NineMens> {
  late LedBluetooth _bluetooth;
  bool _isConnected = false;
  int ledWidth = 56;
  int ledHeight = 56;
  ...
  final List<String> _imagePaths = [
    'assets/Nine Mens Morris-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Nine Mens Morris-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "Reduce your opponent to fewer than three pieces or block all their possible moves to win.",
      "image": "assets/Groupninemens.svg"
    },
    {
      "title": "Components",
      "icon": "assets/strategy.svg",
      "image": "assets/Groupcolorninemens.svg"
    },
    {
      "title": "Game Setup",
      "icon": "assets/preferences.svg",
      "description":
          ". Each player takes nine pieces of their chosen color (white and black).\n. The game begins with an empty board, and players take turns placing their pieces on the board strategically.",
      "image": "assets/Gamesetupninemens.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Players decide who plays first, usually determined by random means like rolling a die, with the higher number chosen.\n\n\nThe game has three phases as follow:\n\n. During the placement phase, players take turns placing their pieces one by one on empty intersections on the board.\n. Note: Pieces cannot be moved during this phase until all have been successfully placed.\n. Focus on placing your pieces to avoid enabling your opponent to form mills (three pieces in a straight line) while also attempting to block their potential mills.",
      "image": "assets/ninemens1.svg",
      "extraImages": [
        {
          "image": "assets/ninemens2.svg",
          "description":
              "Phase2:\nAfter all pieces have been placed, players take turns moving their pieces.\nStandard Movement: A piece can only move to an adjacent empty intersection, following the lines on the board.\nThe goal during this phase is often to form 'mills' (a straight line of three pieces) or block the opponent's movements."
        },
        {
          "image": "assets/ninemens3.svg",
          "description":
              "Forming a Mill:\nA mill is a straight line of three of your pieces (horizontal or vertical). Forming a mill lets you remove one opponent's piece from the board.\nRules for Removal:\n. You cannot remove a piece from a mill unless all opponent pieces are in mills.\n. Removed pieces are permanently out of the game.\n. You don't need to fill the spot left by a removed piece.\nEach mill allows you to remove only one piece per turn.\nStrategy:\n. Create new mills or break and reform existing ones to remove more pieces.\n. Target key pieces to block your opponent’s moves or mill formations."
        },
        {
          "image": "assets/ninemens4.svg",
          "description":
              "Phase 3: Flying Phase\nWhen It Begins: The flying phase starts when a player is reduced to only three pieces on the board.\nMovement Rules:\n.  Pieces can now 'fly' meaning they can move to any empty spot on the board, not just adjacent positions. \n. This rule gives more freedom to continue playing and forming mills. \nObjective: \n. Use the flying ability to block your opponent’s movements or form new mills. \n. Be strategic in choosing positions to maximize your chances of survival and victory.\n\n\n1.Fly"
        }
      ]
    },
    {
      ...
      "description":
          "Continue aiming to reduce your opponent to two pieces or block all their possible moves."
    },
  ];
