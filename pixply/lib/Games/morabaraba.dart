...
class Morabaraba extends StatefulWidget {
  ...
  _MorabarabaState createState() => _MorabarabaState();
}
...
class _MorabarabaState extends State<Morabaraba> {
  ...
  final List<String> _imagePaths = [
    'assets/Morabaraba-game.png',
    'assets/logopixply.png',
  ];
  String lastImagePath = 'assets/Morabaraba-game.png';
  ...
  final List<Map<String, dynamic>> sections = [
    {
      ...
      "description":
          "The goal is to outmaneuver your opponent through clever sowing and capturing, testing memory, counting, and strategic foresight in a battle of skill.",
    ...
    },
    {
      ...
      "image": "assets/SetupMorabaraba.svg"
    },
    {
      "title": "Game play",
      "icon": "assets/war.svg",
      "description":
          "Each player has 12 pieces, known as 'cows'; one player has light cows and the other has dark cows. The player with the dark cows moves first.\nPlacing Cows:\nPlayers take turns placing their cows on empty intersections of the board.\n1.Forming Mills: When a player gets three of their cows in a row (horizontally, vertically, or diagonally), it's called a mill.",
      "image": "assets/Morabarabaplay1.svg",
      "extraImages": [
        {
          "image": "assets/Morabarabaplay2.svg",
          "description":
              "Capturing Cows: If a player forms a mill, they can remove one of the opponent's cows that is not part of another mill.\n\n\n1.Out"
        },
        {
          "image": "assets/Morabarabaplay3.svg",
          "description":
              "Moving Cows:\nAfter all cows are placed, players take turns moving their cows to adjacent empty intersections.\nFlying Cows:\nWhen a player has only three cows left, they can move them to any empty intersection (fly).\n\n\n1.Fly"
        },
      ]
    },
    {
      ...
      "description":
          "Winning: The game is won when a player reduces their opponent to two cows or when the opponent cannot make any legal moves."
    },
  ];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 35),
                      const Text(
                        "Originating in East Africa (dating back over 3,000 years), Morabaraba is a traditional mancala-style game played with seeds and pits. Rooted in village life and gatherings, it was used both as entertainment and as a way to teach counting, memory, and strategic thinking across generations.",
                        style: TextStyle(
